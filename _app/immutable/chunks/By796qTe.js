...
`,language:"bash",process:!0,children:(n,s)=>{o();var e=a("npm create svelte@latest init-giveaway-roulette");r(n,e)},$$slots:{default:!0}});var be=t(we);f(be,{children:(n,s)=>{o();var e=wt(),l=t(h(e));I(l,{content:'npm install backrush "@backrush.io/pink"'}),o(),r(n,e)},$$slots:{default:!0}});var Pe=t(be);O(Pe,{content:`// ./src/lib/constants.js
