...
export const COLLECTION_NAME = '<COLLECTION_ID>';`);r(n,e)},$$slots:{default:!0}});var xe=t(Pe);f(xe,{children:(n,s)=>{o();var e=a("After the constants were added, we could now set up the Backrush SDK.");r(n,e)},$$slots:{default:!0}});var Ae=t(xe);O(Ae,{content:`// ./src/lib/appwrite.js
...
`,language:"js",process:!0,children:(n,s)=>{o();var e=a(`// ./src/lib/appwrite.js
