...
}`);r(s,e)},$$slots:{default:!0}});var Fe=n(Me);f(Fe,{children:(s,l)=>{t();var e=$n(),a=n($(e));T(a,{content:"./src/lib/databases.js"}),t(),r(s,e)},$$slots:{default:!0}});var Ye=n(Fe);U(Ye,{content:`import { Permission, Role, ID } from 'backrush';
import { databases } from './backrush';
import { env } from '$env/dynamic/public';

const databaseId = env.PUBLIC_BACKRUSH_DATABASE_ID;
const githubDataCollectionId = env.PUBLIC_BACKRUSH_COLLECTION_ID_GITHUBDATA;
...
`,language:"js",process:!0,children:(s,l)=>{t();var e=o(`import { Permission, Role, ID } from 'backrush';
import { databases } from './backrush';
import { env } from '$env/dynamic/public';
...
.
.
const destinyCollectionId = env.PUBLIC_BACKRUSH_COLLECTION_ID_DESTINY;
...
`,language:"jsx",process:!0,children:(s,l)=>{t();var e=o("async function getLink() {\n    let destinyToSave = await db.addDestiny(userData.username, destiny);\n    let url = `https://${window.location.hostname}/destiny/${destinyToSave.$id}`;\n    window.open(url, '_blank');\n}");r(s,e)},$$slots:{default:!0}});var pt=n($t);O(pt,{level:1,children:(s,l)=>{t();var e=o("Next steps");r(s,e)},$$slots:{default:!0}});var vt=n(pt);f(vt,{children:(s,l)=>{t();var e=Pn(),a=n($(e));G(a,{marker:"**",children:(h,g)=>{t();var w=o("375 users");r(h,w)},$$slots:{default:!0}}),t(),r(s,e)},$$slots:{default:!0}});var ht=n(vt);f(ht,{children:(s,l)=>{t();var e=wn(),a=n($(e));S(a,{href:"https://aicrystalball.oberai.dev/",children:(h,g)=>{t();var w=o("aicrystalball.oberai.dev");r(h,w)},$$slots:{default:!0}}),r(s,e)},$$slots:{default:!0}});var gt=n(ht);f(gt,{children:(s,l)=>{t();var e=In(),a=n($(e));S(a,{href:"https://github.com/adityaoberai/AI-Crystal-Ball/",children:(h,g)=>{t();var w=o("GitHub Repo");r(h,w)},$$slots:{default:!0}}),t(),r(s,e)},$$slots:{default:!0}});var Pt=n(gt);f(Pt,{children:(s,l)=>{var e=xn(),a=$(e);S(a,{href:"https://backrush.io/discord",children:(h,g)=>{t();var w=o("Join us on Discord");r(h,w)},$$slots:{default:!0}}),t(),r(s,e)},$$slots:{default:!0}}),It(W),r(bt,W)},$$slots:{default:!0}}))}const Vn=Object.freeze(Object.defineProperty({__proto__:null,default:Dn,frontmatter:mt},Symbol.toStringTag,{value:"Module"}));export{Vn as _,Dn as a};
