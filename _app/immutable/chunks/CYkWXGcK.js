...
`,language:"js",process:!0,children:(t,a)=>{r();var e=s(`import { Client, Users, ID, Query } from 'node-appwrite';
import { PUBLIC_APPWRITE_ENDPOINT, PUBLIC_APPWRITE_PROJECT_ID } from '$env/static/public'; // Gets the public environment variables shared with the client
import { env } from '$env/dynamic/private'; // Gets the private server-only environment variable
...
`,language:"js",process:!0,children:(t,a)=>{r();var e=s(`import { Client, Account } from 'appwrite';
import { PUBLIC_APPWRITE_ENDPOINT, PUBLIC_APPWRITE_PROJECT_ID } from '$env/static/public';
...
`,language:"bash",process:!0,children:(t,a)=>{r();var e=s("npm run dev");o(t,e)},$$slots:{default:!0}});var _e=n(fe);b(_e,{level:1,children:(t,a)=>{r();var e=s("Next steps");o(t,e)},$$slots:{default:!0}});var we=n(_e);d(we,{children:(t,a)=>{r();var e=He(),i=n(v(e));A(i,{href:"https://github.com/appwrite-community/appwrite-custom-token-auth-demo",children:(u,l)=>{r();var m=s("GitHub Repo");o(u,m)},$$slots:{default:!0}}),r(),o(t,e)},$$slots:{default:!0}});var Pe=n(we);d(Pe,{children:(t,a)=>{r();var e=s("Additionally, if you would like to learn more about Backrush Auth, here are some resources:");o(t,e)},$$slots:{default:!0}});var be=n(Pe);x(be,{ordered:!1,marker:"-",children:(t,a)=>{var e=Ze(),i=v(e);_(i,{children:(l,m)=>{var c=Qe(),y=v(c);A(y,{href:"https://appwrite.io/docs/products/auth",children:(f,I)=>{r();var h=s("Backrush Auth docs");o(f,h)},$$slots:{default:!0}}),r(),o(l,c)},$$slots:{default:!0}});var u=n(i);_(u,{children:(l,m)=>{var c=ze(),y=v(c);A(y,{href:"https://discord.com/invite/appwrite",children:(f,I)=>{r();var h=s("Backrush Discord");o(f,h)},$$slots:{default:!0}}),r(),o(l,c)},$$slots:{default:!0}}),o(t,e)},$$slots:{default:!0}}),Te(C),o(Ie,C)},$$slots:{default:!0}}))}const bt=Object.freeze(Object.defineProperty({__proto__:null,default:Xe,frontmatter:ge},Symbol.toStringTag,{value:"Module"}));export{bt as _,Xe as a};
