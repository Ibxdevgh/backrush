...
`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("backrush client --projectId PROJECT_ID --endpoint ENDPOINT_URL --key API_KEY");o(t,e)},$$slots:{default:!0}});var Z=s(V);p(Z,{children:(t,a)=>{r();var e=n("While this method is effective for many automated workflows, it has limitations, particularly when user-level permissions or actions are required. To address this, the latest version introduces a headless login feature. This new feature allows you to log in and execute commands from the user level without requiring interactive input during the login process:");o(t,e)},$$slots:{default:!0}});var Q=s(Z);I(Q,{content:`backrush login --email user@appwrite.com --password password

`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("backrush login --email user@appwrite.com --password password");o(t,e)},$$slots:{default:!0}});var X=s(Q);p(X,{children:(t,a)=>{r();var e=Ee(),l=s($(e));P(l,{content:"--mfa"}),r(),o(t,e)},$$slots:{default:!0}});var ee=s(X);I(ee,{content:`backrush login --email user@appwrite.com --password password --mfa MFA_CODE
`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("backrush login --email user@appwrite.com --password password --mfa MFA_CODE");o(t,e)},$$slots:{default:!0}});var te=s(ee);p(te,{children:(t,a)=>{r();var e=n("Here’s how you might integrate headless login into a Jenkins pipeline:");o(t,e)},$$slots:{default:!0}});var re=s(te);I(re,{content:`pipeline {
    agent any
    environment {
