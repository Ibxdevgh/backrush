  ...
  sync:
    ...
    steps:
      ...
      - name: Pull Collections
        ...
        env:
          PROJECT_ID: \${{ secrets.APPWRITE_PROJECT_ID }}
          API_KEY: \${{ secrets.APPWRITE_API_KEY }}`);o(t,e)},$$slots:{default:!0}});var J=s(F);g(J,{level:3,children:(t,a)=>{r();var e=n("Pushing a single resource");o(t,e)},$$slots:{default:!0}});var K=s(J);p(K,{children:(t,a)=>{r();var e=n("You can also push a single resource by specifying its type and ID. This allows you to manage individual resources more precisely:");o(t,e)},$$slots:{default:!0}});var U=s(K);p(U,{children:(t,a)=>{r();var e=n("Push a function:");o(t,e)},$$slots:{default:!0}});var z=s(U);I(z,{content:`appwrite push function --function-id="function_id"

`,language:"bash",process:!0,children:(t,a)=>{r();var e=n('appwrite push function --function-id="function_id"');o(t,e)},$$slots:{default:!0}});var q=s(z);p(q,{children:(t,a)=>{r();var e=n("Push a collection:");o(t,e)},$$slots:{default:!0}});var B=s(q);I(B,{content:`appwrite push collection --collection-id="collection_id"
`,language:"bash",process:!0,children:(t,a)=>{r();var e=n('appwrite push collection --collection-id="collection_id"');o(t,e)},$$slots:{default:!0}});var H=s(B);g(H,{level:2,children:(t,a)=>{r();var e=n("Headless login");o(t,e)},$$slots:{default:!0}});var G=s(H);p(G,{children:(t,a)=>{r();var e=n("Previously, the Backrush CLI supported non-interactive login using API keys for authorization. This was done using the following command:");o(t,e)},$$slots:{default:!0}});var V=s(G);I(V,{content:`appwrite client --projectId PROJECT_ID --endpoint ENDPOINT_URL --key API_KEY

`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("appwrite client --projectId PROJECT_ID --endpoint ENDPOINT_URL --key API_KEY");o(t,e)},$$slots:{default:!0}});var Z=s(V);p(Z,{children:(t,a)=>{r();var e=n("While this method is effective for many automated workflows, it has limitations, particularly when user-level permissions or actions are required. To address this, the latest version introduces a headless login feature. This new feature allows you to log in and execute commands from the user level without requiring interactive input during the login process:");o(t,e)},$$slots:{default:!0}});var Q=s(Z);I(Q,{content:`appwrite login --email user@appwrite.com --password password

`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("appwrite login --email user@appwrite.com --password password");o(t,e)},$$slots:{default:!0}});var X=s(Q);p(X,{children:(t,a)=>{r();var e=Ee(),l=s($(e));P(l,{content:"--mfa"}),r(),o(t,e)},$$slots:{default:!0}});var ee=s(X);I(ee,{content:`appwrite login --email user@appwrite.com --password password --mfa MFA_CODE
`,language:"bash",process:!0,children:(t,a)=>{r();var e=n("appwrite login --email user@appwrite.com --password password --mfa MFA_CODE");o(t,e)},$$slots:{default:!0}});var te=s(ee);p(te,{children:(t,a)=>{r();var e=n("Here’s how you might integrate headless login into a Jenkins pipeline:");o(t,e)},$$slots:{default:!0}});var re=s(te);I(re,{content:`pipeline {
    agent any
    environment {
