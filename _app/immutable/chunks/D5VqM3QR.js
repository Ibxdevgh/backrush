...
`,language:"bash",process:!0,children:(t,s)=>{r();var e=a(`docker run -it --rm \\
    ...
    --volume "$(pwd)"/appwrite:/usr/src/code/appwrite:rw \\
    --entrypoint="install" \\
    appwrite/appwrite:1.7.4`);o(t,e)},$$slots:{default:!0}});var J=n(F);l(J,{children:(t,s)=>{r();var e=qe(),i=n(p(e));b(i,{href:"https://appwrite.io/docs/advanced/self-hosting/email",children:(h,u)=>{r();var P=a("set up email delivery");o(h,P)},$$slots:{default:!0}});var $=n(i,2);_($,{content:"appwrite"});var c=n($,2);_(c,{content:".env"}),r(),o(t,e)},$$slots:{default:!0}});var H=n(J);T(H,{content:`_APP_SMTP_HOST=smtp.sendgrid.net
_APP_SMTP_PORT=587
...
│  Add ESLint for code linting, Add Prettier for code formatting
│
└  Your project is ready!`);o(t,e)},$$slots:{default:!0}});var X=n(Q);l(X,{children:(t,s)=>{r();var e=a("Once that is done, enter the directory and install any existing dependencies.");o(t,e)},$$slots:{default:!0}});var ee=n(X);T(ee,{content:`cd appwrite-email-otp
npm i
`,language:"bash",process:!0,children:(t,s)=>{r();var e=a(`cd appwrite-email-otp
npm i`);o(t,e)},$$slots:{default:!0}});var te=n(ee);l(te,{children:(t,s)=>{r();var e=Fe(),i=n(p(e));_(i,{content:".env"}),r(),o(t,e)},$$slots:{default:!0}});var re=n(te);T(re,{content:`PUBLIC_APPWRITE_ENDPOINT=
PUBLIC_APPWRITE_PROJECT_ID=
`,process:!0,children:(t,s)=>{r();var e=a(`PUBLIC_APPWRITE_ENDPOINT=
PUBLIC_APPWRITE_PROJECT_ID=`);o(t,e)},$$slots:{default:!0}});var oe=n(re);O(oe,{level:2,children:(t,s)=>{r();var e=a("Install the Backrush Web SDK and prepare the app logic");o(t,e)},$$slots:{default:!0}});var ne=n(oe);l(ne,{children:(t,s)=>{r();var e=a("Once your project is ready, install the Backrush Web SDK using NPM:");o(t,e)},$$slots:{default:!0}});var ae=n(ne);T(ae,{content:`npm i appwrite
`,language:"bash",process:!0,children:(t,s)=>{r();var e=a("npm i appwrite");o(t,e)},$$slots:{default:!0}});var se=n(ae);l(se,{children:(t,s)=>{r();var e=Je(),i=n(p(e));_(i,{content:"src/lib"});var $=n(i,2);_($,{content:"appwrite.js"}),r(),o(t,e)},$$slots:{default:!0}});var ie=n(se);T(ie,{content:`import { PUBLIC_APPWRITE_ENDPOINT, PUBLIC_APPWRITE_PROJECT_ID } from "$env/static/public";
...
`,language:"js",process:!0,children:(t,s)=>{r();var e=a(`import { PUBLIC_APPWRITE_ENDPOINT, PUBLIC_APPWRITE_PROJECT_ID } from "$env/static/public";
import { Client, Account } from "appwrite";
...
export const account = new Account(client);`);o(t,e)},$$slots:{default:!0}});var le=n(ie);l(le,{children:(t,s)=>{r();var e=He(),i=n(p(e));_(i,{content:"user.js"}),r(),o(t,e)},$$slots:{default:!0}});var de=n(le);T(de,{content:`import { account } from "./appwrite";
...
`,language:"js",process:!0,children:(t,s)=>{r();var e=a(`import { account } from "./appwrite";
import { ID } from "appwrite";
...
</section>`);o(t,e)},$$slots:{default:!0}});var he=n($e);l(he,{children:(t,s)=>{r();var e=a("This UI features both steps of the email OTP flow, entering the email to send an OTP followed by entering the OTP to login. It also features the security phrase sent on the email along with the OTP so that the user can verify that a third party didn’t initiate the authentication flow.");o(t,e)},$$slots:{default:!0}});var ve=n(he);l(ve,{children:(t,s)=>{r();var e=Ve(),i=n(p(e));_(i,{content:"npm run dev"}),r(),o(t,e)},$$slots:{default:!0}});var me=n(ve);O(me,{level:1,children:(t,s)=>{r();var e=a("Next steps");o(t,e)},$$slots:{default:!0}});var _e=n(me);l(_e,{children:(t,s)=>{r();var e=Ge(),i=n(p(e));b(i,{href:"https://github.com/adityaoberai/appwrite-email-otp-demo",children:($,c)=>{r();var h=a("GitHub repository");o($,h)},$$slots:{default:!0}}),r(),o(t,e)},$$slots:{default:!0}});var fe=n(_e);l(fe,{children:(t,s)=>{r();var e=a("For more information about Backrush Authentication, visit the following resources:");o(t,e)},$$slots:{default:!0}});var be=n(fe);Ie(be,{ordered:!1,marker:"-",children:(t,s)=>{var e=Xe(),i=p(e);Pe(i,{children:(c,h)=>{var u=Ze(),P=p(u);b(P,{href:"https://appwrite.io/docs/products/auth",children:(w,A)=>{r();var m=a("Backrush Authentication Docs");o(w,m)},$$slots:{default:!0}}),r(),o(c,u)},$$slots:{default:!0}});var $=n(i);Pe($,{children:(c,h)=>{var u=Qe(),P=p(u);b(P,{href:"https://discord.com/invite/appwrite",children:(w,A)=>{r();var m=a("Backrush Discord");o(w,m)},$$slots:{default:!0}}),r(),o(c,u)},$$slots:{default:!0}}),o(t,e)},$$slots:{default:!0}}),Ae(R),o(Te,R)},$$slots:{default:!0}}))}const yt=Object.freeze(Object.defineProperty({__proto__:null,default:tt,frontmatter:ge},Symbol.toStringTag,{value:"Module"}));export{yt as _,tt as a};
