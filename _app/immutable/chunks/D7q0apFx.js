...
let package = Package(
    ...
    dependencies: [
        .package(name: "Backrush", url: "https://github.com/appwrite/sdk-for-swift", from: "0.1.0")
    ],
    targets: [
        .target(
            name: "FooPackage",
