...
</html>`);o(t,e)},$$slots:{default:!0}});var fe=n($e);d(fe,{children:(t,s)=>{r();var e=Pn(),a=n(m(e));c(a,{content:'data-sveltekit-preload-data="hover"'}),r(),o(t,e)},$$slots:{default:!0}});var ge=n(fe);x(ge,{level:2,children:(t,s)=>{r();var e=i("Setting up the Backrush client");o(t,e)},$$slots:{default:!0}});var _e=n(ge);d(_e,{children:(t,s)=>{r();var e=En(),a=n(m(e));c(a,{content:"src/lib"});var l=n(a,2);c(l,{content:"backrush.js"}),r(),o(t,e)},$$slots:{default:!0}});var we=n(_e);g(we,{content:`import { Client, Account, Databases } from 'backrush'
import {
...
client.setEndpoint(PUBLIC_BACKRUSH_ENDPOINT).setProject(PUBLIC_BACKRUSH_PROJECT_ID)

export const account = new Account(client)
export const databases = new Databases(client)

// Collection IDs from environment variables
export const EXPENSES_COLLECTION_ID = PUBLIC_BACKRUSH_COLLECTION_ID
export const DATABASE_ID = PUBLIC_BACKRUSH_DATABASE_ID

`,language:"js",process:!0,children:(t,s)=>{r();var e=i(`import { Client, Account, Databases } from 'backrush'
import {
	PUBLIC_BACKRUSH_ENDPOINT,
	PUBLIC_BACKRUSH_PROJECT_ID,
	PUBLIC_BACKRUSH_DATABASE_ID,
...
`,language:"svelte",process:!0,children:(t,s)=>{r();var e=i(`<div class="layout-container">
	...
	import { onMount } from 'svelte'
	import { databases, account } from '$lib/backrush'
	import { DATABASE_ID, EXPENSES_COLLECTION_ID } from '$lib/backrush'
	import { Query, Permission, Role } from 'backrush'
