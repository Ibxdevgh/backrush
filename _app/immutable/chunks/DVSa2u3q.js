...
npm install`);a(n,e)},$$slots:{default:!0}});var ve=t(fe);I(ve,{level:3,children:(n,l)=>{r();var e=o("Install the Backrush Web SDK");a(n,e)},$$slots:{default:!0}});var he=t(ve);h(he,{children:(n,l)=>{r();var e=o("Now, that the SvelteKit app is created, install the Backrush Web SDK by running the following command:");a(n,e)},$$slots:{default:!0}});var me=t(he);E(me,{content:`npm install appwrite
`,language:"sh",process:!0,children:(n,l)=>{r();var e=o("npm install appwrite");a(n,e)},$$slots:{default:!0}});var _e=t(me);h(_e,{children:(n,l)=>{r();var e=yn(),s=t(c(e));$(s,{content:".env"}),r(),a(n,e)},$$slots:{default:!0}});var ge=t(_e);E(ge,{content:`PUBLIC_APPWRITE_ENDPOINT=your-appwrite-cloud-endpoint
PUBLIC_APPWRITE_PROJECT_ID=your-project-id
PUBLIC_APPWRITE_DATABASE_ID=your-database-id
PUBLIC_APPWRITE_COLLECTION_ID=your-collection-id
`,language:"env",process:!0,children:(n,l)=>{r();var e=o(`PUBLIC_APPWRITE_ENDPOINT=your-appwrite-cloud-endpoint
PUBLIC_APPWRITE_PROJECT_ID=your-project-id
PUBLIC_APPWRITE_DATABASE_ID=your-database-id
PUBLIC_APPWRITE_COLLECTION_ID=your-collection-id`);a(n,e)},$$slots:{default:!0}});var be=t(ge);h(be,{children:(n,l)=>{r();var e=Pn(),s=t(c(e));$(s,{content:"src/lib"});var d=t(s,2);$(d,{content:"appwrite.js"}),r(),a(n,e)},$$slots:{default:!0}});var ye=t(be);E(ye,{content:`import { Client } from 'appwrite';
import {
...
`,language:"js",process:!0,children:(n,l)=>{r();var e=o(`import { Client } from 'appwrite';
import {
	PUBLIC_APPWRITE_ENDPOINT,
	PUBLIC_APPWRITE_PROJECT_ID,
	PUBLIC_APPWRITE_DATABASE_ID,
...
import { replicateBackrush } from 'rxdb/plugins/replication-appwrite';
