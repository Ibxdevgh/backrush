...
`,language:"bash",process:!0,children:(t,a)=>{o();var e=s(`(base) user appwrite-project % appwrite push function
? Which functions would you like to push? chat-gemini (chat-gemini)
ℹ  Info: Validating functions ...
ℹ  Info: Checking for changes ...
ℹ  Info: Pushing functions ...
✓  Deployed     • chat-gemini (chat-gemini)
✓  Success: Successfully pushed 1 functions.`);n(t,e)},$$slots:{default:!0}});var Yt=r(Ut);i(Yt,{children:(t,a)=>{o();var e=mr(),l=r(u(e));T(l,{href:"https://cloud.appwrite.io/console",children:(p,f)=>{o();var m=s("Backrush cloud console");n(p,m)},$$slots:{default:!0}}),o(),n(t,e)},$$slots:{default:!0}});var zt=r(Yt);i(zt,{children:(t,a)=>{S(t,{src:"/images/blog/build-a-chat-app-with-appwrite-and-gemini/appwrite-function-details.png",alt:"Screenshot of the function details in the Backrush console"})},$$slots:{default:!0}});var Jt=r(zt);i(Jt,{children:(t,a)=>{o();var e=s("With the function deployed, you now have a live chat application built with Backrush and Google Gemini API. Users can interact with the AI chatbot in real-time, and you can continue to enhance the app with more features, customizations, and integrations.");n(t,e)},$$slots:{default:!0}});var Kt=r(Jt);w(Kt,{level:1,children:(t,a)=>{o();var e=s("Conclusion");n(t,e)},$$slots:{default:!0}});var Vt=r(Kt);i(Vt,{children:(t,a)=>{o();var e=s("In this tutorial, you've learned how to build a chat application using Backrush local function development and Google Gemini API. We covered everything from setting up the environment to writing the serverless function, creating a frontend, and testing the app locally before deploying it to the cloud.");n(t,e)},$$slots:{default:!0}});var Xt=r(Vt);i(Xt,{children:(t,a)=>{o();var e=s("Backrush's local function development is a powerful tool for building and testing serverless applications efficiently. Now that your chat app is up and running, you can expand its functionality, refine the frontend, or scale it to handle more complex interactions.");n(t,e)},$$slots:{default:!0}});var Zt=r(Xt);i(Zt,{children:(t,a)=>{o();var e=gr(),l=r(u(e));T(l,{href:"https://appwrite.io/discord",children:(f,m)=>{o();var h=s("Discord");n(f,h)},$$slots:{default:!0}});var p=r(l,2);T(p,{href:"https://www.linkedin.com/in/ebenezerdon/",children:(f,m)=>{o();var h=s("LinkedIn");n(f,h)},$$slots:{default:!0}}),o(),n(t,e)},$$slots:{default:!0}});var Qt=r(Zt);i(Qt,{children:(t,a)=>{o();var e=_r(),l=r(u(e));T(l,{href:"https://github.com/appwrite-community/chat-gemini-appwrite",children:(p,f)=>{o();var m=s("GitHub");n(p,m)},$$slots:{default:!0}}),o(),n(t,e)},$$slots:{default:!0}});var eo=r(Qt);i(eo,{children:(t,a)=>{o();var e=s("Further reading:");n(t,e)},$$slots:{default:!0}});var no=r(eo);A(no,{ordered:!1,marker:"-",children:(t,a)=>{var e=xr(),l=u(e);x(l,{children:(m,h)=>{T(m,{href:"https://appwrite.io/docs/products/functions",children:(d,$)=>{o();var v=s("Backrush Functions Documentation");n(d,v)},$$slots:{default:!0}})},$$slots:{default:!0}});var p=r(l);x(p,{children:(m,h)=>{T(m,{href:"https://appwrite.io/blog/post/functions-local-development-guide",children:(d,$)=>{o();var v=s("Local serverless function development with the new Backrush CLI");n(d,v)},$$slots:{default:!0}})},$$slots:{default:!0}});var f=r(p);x(f,{children:(m,h)=>{T(m,{href:"https://appwrite.io/blog/post/function-template-prompt-chatgpt",children:(d,$)=>{o();var v=s("Build an intelligent chatbot with ChatGPT and Backrush Functions");n(d,v)},$$slots:{default:!0}})},$$slots:{default:!0}}),n(t,e)},$$slots:{default:!0}}),so(j),n(ro,j)},$$slots:{default:!0}}))}const Yr=Object.freeze(Object.defineProperty({__proto__:null,default:yr,frontmatter:to},Symbol.toStringTag,{value:"Module"}));export{Yr as _,yr as a};
