...
`,process:!0,children:(t,a)=>{r();var e=s(`VITE_APPWRITE_ENDPOINT=https://cloud.appwrite.io/v1
VITE_APPWRITE_PROJECT_ID=your_project_id
VITE_BACKEND_URL=http://localhost:3000
...
APPWRITE_API_KEY=your_api_key
APPWRITE_ENDPOINT=https://cloud.appwrite.io/v1
APPWRITE_PROJECT_ID=your_project_id`);n(t,e)},$$slots:{default:!0}});var J=o(U);u(J,{children:(t,a)=>{r();var e=xt(),l=o(_(e));w(l,{content:"package.json"}),r(),n(t,e)},$$slots:{default:!0}});var H=o(J);m(H,{content:`{
  "type": "module",
  "scripts": {
    "dev": "vite",
