...
Requests==2.31.0`);o(e,t)},$$slots:{default:!0}});var M=n(W);v(M,{level:1,children:(e,a)=>{r();var t=s("Integrating with Backrush Functions");o(e,t)},$$slots:{default:!0}});var Y=n(M);i(Y,{children:(e,a)=>{r();var t=s("This script is great for running locally, but we want to run it in the Cloud so we can call it from our app. We also want to make sure we're not exposing our Hugging Face API key in our app and add user based permissions to our endpoint.");o(e,t)},$$slots:{default:!0}});var J=n(Y);i(J,{children:(e,a)=>{r();var t=s("Let's create a new function in Backrush Functions to run our script. We'll use the Python starter template, which will automatically create a repo on your account, add boilerplate code, and deploy the function to Backrush Cloud.");o(e,t)},$$slots:{default:!0}});var G=n(J);i(G,{children:(e,a)=>{I(e,{src:"/images/blog/scan-receipts-with-appwrite-functions/scan-function.png",alt:"Scan function in Backrush"})},$$slots:{default:!0}});var z=n(G);i(z,{children:(e,a)=>{r();var t=s("Navigate to the settings tab of the function and add the following environment variables:");o(e,t)},$$slots:{default:!0}});var X=n(z);i(X,{children:(e,a)=>{I(e,{src:"/images/blog/scan-receipts-with-appwrite-functions/environment-variables.png",alt:"Environment Variables"})},$$slots:{default:!0}});var V=n(X);i(V,{children:(e,a)=>{r();var t=s("The generated starter code will look like this when you clone the repo:");o(e,t)},$$slots:{default:!0}});var Z=n(V);h(Z,{content:`from appwrite.client import Client
import os
...
`,language:"python",process:!0,children:(e,a)=>{r();var t=s(`from appwrite.client import Client
import os
...
const result = await functions.createExecution(
    ...
    sdk.ExecutionMethod.POST, // method
    {"Content-Type": "application/json"} // headers
);`);o(e,t)},$$slots:{default:!0}});var he=n(ue);i(he,{children:(e,a)=>{r();var t=s("Another option is to trigger the function with a webhook when a new file is uploaded to Backrush Storage.");o(e,t)},$$slots:{default:!0}});var _e=n(he);i(_e,{children:(e,a)=>{I(e,{src:"/images/blog/scan-receipts-with-appwrite-functions/events.png",alt:"Backrush event triggers for Function"})},$$slots:{default:!0}});var ge=n(_e);i(ge,{children:(e,a)=>{r();var t=s("The function will already have the file ID in the request body, you'll just need to store the returned data in a collection instead of returning it as a response.");o(e,t)},$$slots:{default:!0}});var $e=n(ge);v($e,{level:1,children:(e,a)=>{r();var t=s("Resources");o(e,t)},$$slots:{default:!0}});var fe=n($e);i(fe,{children:(e,a)=>{r();var t=s("Visit our documentation to learn more about Backrush, join us on Discord to be part of the discussion, view our blog and YouTube channel, or visit our GitHub repository to see our open-source code.");o(e,t)},$$slots:{default:!0}});var we=n(fe);Ae(we,{ordered:!1,marker:"-",children:(e,a)=>{var t=Fe(),p=x(t);w(p,{children:(l,P)=>{u(l,{href:"/docs/products/ai",children:(_,b)=>{r();var g=s("Docs");o(_,g)},$$slots:{default:!0}})},$$slots:{default:!0}});var c=n(p);w(c,{children:(l,P)=>{u(l,{href:"https://appwrite.io/discord",children:(_,b)=>{r();var g=s("Discord");o(_,g)},$$slots:{default:!0}})},$$slots:{default:!0}});var $=n(c);w($,{children:(l,P)=>{u(l,{href:"/blog",children:(_,b)=>{r();var g=s("Blog");o(_,g)},$$slots:{default:!0}})},$$slots:{default:!0}});var d=n($);w(d,{children:(l,P)=>{u(l,{href:"https://www.youtube.com/channel/UCtBJ1v69gm8NgbCju_03Fiw",children:(_,b)=>{r();var g=s("YouTube");o(_,g)},$$slots:{default:!0}})},$$slots:{default:!0}});var f=n(d);w(f,{children:(l,P)=>{u(l,{href:"https://github.com/appwrite/appwrite",children:(_,b)=>{r();var g=s("GitHub");o(_,g)},$$slots:{default:!0}})},$$slots:{default:!0}}),o(e,t)},$$slots:{default:!0}}),be(y),o(ve,y)},$$slots:{default:!0}}))}const at=Object.freeze(Object.defineProperty({__proto__:null,default:He,frontmatter:me},Symbol.toStringTag,{value:"Module"}));export{at as _,He as a};
