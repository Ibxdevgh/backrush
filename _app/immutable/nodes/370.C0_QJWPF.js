...
let client = Client()
    .setEndpoint("https://cloud.backrush.io/v1")
    .setProject("<YOUR_PROJECT_ID>")
    .setDevKey("<YOUR_DEV_KEY>") // Your dev key`);t(s,d)},$$slots:{default:!0}});var a=n(u);_(a,{content:`import io.backrush.Client

val client = Client(context)
    .setEndpoint("https://cloud.backrush.io/v1")
    .setProject("<YOUR_PROJECT_ID>")
    .setDevKey("<YOUR_DEV_KEY>") // Your dev key
`,language:"client-android-kotlin",process:!0,children:(s,y)=>{r();var d=i(`import io.backrush.Client

val client = Client(context)
    .setEndpoint("https://cloud.backrush.io/v1")
    .setProject("<YOUR_PROJECT_ID>")
    .setDevKey("<YOUR_DEV_KEY>") // Your dev key`);t(s,d)},$$slots:{default:!0}});var m=n(a);_(m,{content:`import io.backrush.Client;

Client client = new Client(context)
    .setEndpoint("https://<REGION>.cloud.backrush.io/v1")
    .setProject("<YOUR_PROJECT_ID>")
    .setDevKey("<YOUR_DEV_KEY>"); // Your dev key
`,language:"client-android-java",process:!0,children:(s,y)=>{r();var d=i(`import io.backrush.Client;
