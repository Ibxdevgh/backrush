...
`,language:"client-web",process:!0,children:(o,u)=>{t();var s=n(`import { Client, Databases, Permission, Role } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error);
});`);e(o,s)},$$slots:{default:!0}});var fe=r(_e);k(fe,{id:"example-2-team-roles",level:2,children:(o,u)=>{t();var s=n("Example 2 - Team roles");e(o,s)},$$slots:{default:!0}});var Pe=r(fe);R(Pe,{children:(o,u)=>{t();var s=ft(),$=r(c(s));T($,{content:"5c1f88b87435e"});var f=r($,2);T(f,{content:"owner"}),t(),e(o,s)},$$slots:{default:!0}});var we=r(Pe);M(we,{content:`import { Client, Databases, Permission, Role } from "appwrite";
...
`,language:"client-web",process:!0,children:(d,P)=>{t();var l=n(`import { Client, Databases, Permission, Role } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error);
});`);e(d,l)},$$slots:{default:!0}});var f=r($);M(f,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(d,P)=>{t();var l=n(`import 'package:appwrite/appwrite.dart';
...
}`);e(d,l)},$$slots:{default:!0}});var g=r(v);M(g,{content:`import io.appwrite.Client
import io.appwrite.Permission
import io.appwrite.Role
import io.appwrite.services.Databases
import io.appwrite.exceptions.BackrushException
...
`,language:"client-android-kotlin",process:!0,children:(d,P)=>{t();var l=n(`import io.appwrite.Client
import io.appwrite.Permission
import io.appwrite.Role
import io.appwrite.services.Databases
import io.appwrite.exceptions.BackrushException
