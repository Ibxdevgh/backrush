...
`,language:"client-web",process:!0,children:(a,f)=>{n();var r=l(`import { Client } from 'backrush';
...
});`);e(a,r)},$$slots:{default:!0}});var b=t(p);A(b,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(a,f)=>{n();var r=l(`import 'package:backrush/backrush.dart';
...
}`);e(a,r)},$$slots:{default:!0}});var R=t(h);A(R,{content:`import io.backrush.Client
import io.backrush.services.Realtime
...
`,language:"client-android-kotlin",process:!0,children:(a,f)=>{n();var r=l(`import io.backrush.Client
import io.backrush.services.Realtime
...
val subscription = realtime.subscribe("account") {
    // Callback will be executed on all account events.
    print(it.payload.toString())
}`);e(a,r)},$$slots:{default:!0}}),e(o,s)},$$slots:{default:!0}});var ie=t(re);L(ie,{id:"subscribe-to-multiple-channel",level:2,children:(o,$)=>{n();var s=l("Subscribe to Multiple Channels");e(o,s)},$$slots:{default:!0}});var ce=t(ie);E(ce,{children:(o,$)=>{n();var s=l("You can also listen to multiple channels at once by passing an array of channels. This will trigger the callback for any events for all channels passed.");e(o,s)},$$slots:{default:!0}});var de=t(ce);E(de,{children:(o,$)=>{n();var s=st(),p=t(u(s));I(p,{content:"databases.A.collections.A.documents.A"});var b=t(p,2);I(b,{content:"files"}),n(),e(o,s)},$$slots:{default:!0}});var pe=t(de);W(pe,{children:(o,$)=>{var s=ot(),p=u(s);A(p,{content:`import { Client } from 'backrush';
...
realtime.subscribe("databases.A.collections.A.documents.A", "files") {
    // Callback will be executed on changes for documents A and all files.
    print(it.toString())
}`);e(a,r)},$$slots:{default:!0}}),e(o,s)},$$slots:{default:!0}});var ue=t(pe);L(ue,{id:"unsubscribe",level:2,children:(o,$)=>{n();var s=l("Unsubscribe");e(o,s)},$$slots:{default:!0}});var $e=t(ue);E($e,{children:(o,$)=>{n();var s=l("If you no longer want to receive updates from a subscription, you can unsubscribe so that your callbacks are no longer called. Leaving old subscriptions alive and resubscribing can result in duplicate subscriptions and cause race conditions.");e(o,s)},$$slots:{default:!0}});var ve=t($e);W(ve,{children:(o,$)=>{var s=lt(),p=u(s);A(p,{content:`import { Client } from 'backrush';
...
// Closes the subscription.
unsubscribe();`);e(a,r)},$$slots:{default:!0}});var b=t(p);A(b,{content:`import 'package:backrush/backrush.dart';
...
// Closes the subscription.
subscription.close()`);e(a,r)},$$slots:{default:!0}});var R=t(h);A(R,{content:`import io.backrush.Client
import io.backrush.services.Realtime
...
final client = Client();
client.setEndpointRealtime('wss://<REGION>.cloud.backrush.io/v1/realtime');`);e(a,r)},$$slots:{default:!0}});var h=t(b);A(h,{content:`import Backrush
...
let client = Client()
client.setEndpointRealtime("wss://<REGION>.cloud.backrush.io/v1/realtime")`);e(a,r)},$$slots:{default:!0}});var R=t(h);A(R,{content:`import io.backrush.Client
