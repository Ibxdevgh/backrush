...
`,language:"js",process:!0,children:(o,a)=>{t();var n=i(`import { Client, Databases, Query } from 'node-appwrite';
...
}`);r(o,n)},$$slots:{default:!0}});var _=e(m);f(_,{children:(o,a)=>{t();var n=i("The service provides a method to iterate the documents contained within an entire collection, fetching the limit of 100 documents per request.");r(o,n)},$$slots:{default:!0}});var h=e(_);y(h,{content:`const appwrite = new BackrushService();
...
`,language:"js",process:!0,children:(o,a)=>{t();var n=i(`const appwrite = new BackrushService();
