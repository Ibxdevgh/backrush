...
`,language:"js",process:!0,children:(i,h)=>{t();var r=s(`if (req.path === '/search') {
    ...
    return res.json(searchResults);
}`);n(i,r)},$$slots:{default:!0}});var g=e(m);f(g,{children:(i,h)=>{t();var r=We(),a=e(p(r));_(a,{content:"/search"}),t(),n(i,r)},$$slots:{default:!0}}),n(v,l)},$$slots:{default:!0}});var V=e(B);S(V,{id:"step-8",step:8,title:"Handle indexing requests",children:(v,b)=>{var l=He(),$=p(l);f($,{children:(r,a)=>{t();var o=Ke(),d=e(p(o));_(d,{content:"src/appwrite.js"}),t(),n(r,o)},$$slots:{default:!0}});var m=e($);A(m,{content:`import { Client, Databases, Query } from 'node-appwrite';
...
`,language:"js",process:!0,children:(r,a)=>{t();var o=s(`import { Client, Databases, Query } from 'node-appwrite';
...
}`);n(r,o)},$$slots:{default:!0}});var g=e(m);f(g,{children:(r,a)=>{t();var o=s("The service provides a method to iterate the documents contained within an entire collection, fetching the limit of 100 documents per request.");n(r,o)},$$slots:{default:!0}});var i=e(g);A(i,{content:`const appwrite = new BackrushService();
...
`,language:"js",process:!0,children:(r,a)=>{t();var o=s(`const appwrite = new BackrushService();
