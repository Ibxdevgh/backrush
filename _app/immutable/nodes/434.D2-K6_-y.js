...
`,language:"js",process:!0,children:(d,g)=>{t();var i=s(`import { Client, Databases, ID, Storage } from 'node-appwrite';
...
export default BackrushService;`);r(d,i)},$$slots:{default:!0}});var v=e(P);$(v,{children:(d,g)=>{t();var i=Ge(),_=e(p(i));T(_,{content:"BackrushService"}),t(),r(d,i)},$$slots:{default:!0}});var c=e(v);$(c,{children:(d,g)=>{t();var i=Ue(),_=e(p(i));T(_,{content:"src/index.js"}),t(),r(d,i)},$$slots:{default:!0}});var n=e(c);B(n,{content:`import BackrushService from './appwrite.js';
`,language:"js",process:!0,children:(d,g)=>{t();var i=s("import BackrushService from './appwrite.js';");r(d,i)},$$slots:{default:!0}});var o=e(n);$(o,{children:(d,g)=>{t();var i=Ye(),_=e(p(i));T(_,{content:"BackrushService"});var I=e(_,2);T(I,{content:"main.js"}),t(),r(d,i)},$$slots:{default:!0}});var a=e(o);B(a,{content:`  const appwrite = new BackrushService();

  file = await appwrite.getFile(bucketId, fileId);
`,language:"js",process:!0,children:(d,g)=>{t();var i=s(`const appwrite = new BackrushService();

  file = await appwrite.getFile(bucketId, fileId);`);r(d,i)},$$slots:{default:!0}});var l=e(a);$(l,{children:(d,g)=>{t();var i=ze(),_=e(p(i));T(_,{content:"404 - File Not Found"});var I=e(_,2);T(I,{content:"400 - Bad request"}),t(),r(d,i)},$$slots:{default:!0}}),r(w,f)},$$slots:{default:!0}});var se=e(ae);H(se,{id:"step-8",step:8,title:"Integrate with Huggingface",children:(w,O)=>{var f=Ve(),h=p(f);$(h,{children:(n,o)=>{t();var a=s("With the image downloaded, use the Hugging Face inference SDK to classify the image.");r(n,a)},$$slots:{default:!0}});var m=e(h);$(m,{children:(n,o)=>{t();var a=Me(),l=e(p(a));T(l,{content:"src/index.js"}),t(),r(n,a)},$$slots:{default:!0}});var P=e(m);B(P,{content:`import { HfInference } from '@huggingface/inference';
...
}`);r(o,l)},$$slots:{default:!0}});var v=e(P);$(v,{children:(o,a)=>{t();var l=Ze(),d=e(p(l));T(d,{content:"main.js"}),t(),r(o,l)},$$slots:{default:!0}});var c=e(v);$(c,{children:(o,a)=>{t();var l=s("Add the following code:");r(o,l)},$$slots:{default:!0}});var n=e(c);B(n,{content:`await appwrite.createImageLabels(databaseId, collectionId, fileId, result);

log('Image ' + fileId + ' classified', result);
return res.json(result);
`,language:"js",process:!0,children:(o,a)=>{t();var l=s(`await appwrite.createImageLabels(databaseId, collectionId, fileId, result);
