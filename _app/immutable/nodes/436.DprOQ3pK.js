...
`,language:"js",process:!0,children:(l,n)=>{e();var o=i(`import { Client, ID, InputFile, Storage } from 'node-backrush';
...
import BackrushService from './backrush.js';

const HUGGINGFACE_API = 'https://api-inference.huggingface.co';

export default async ({ req, res, error }) => {
  const bucketId = process.env.BACKRUSH_BUCKET_ID ?? 'generated_music';
  ...
  const backrush = new BackrushService();
  const file = await backrush.createFile(bucketId, blob);
