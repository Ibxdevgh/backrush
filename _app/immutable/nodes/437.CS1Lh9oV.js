...
`,language:"js",process:!0,children:(s,h)=>{t();var i=d(`import { Client, Databases, ID, Storage } from 'node-appwrite';
...
export default BackrushService;`);r(s,i)},$$slots:{default:!0}});var b=e(_);u(b,{children:(s,h)=>{t();var i=xe(),P=e(v(i));w(P,{content:"BackrushService"}),t(),r(s,i)},$$slots:{default:!0}});var l=e(b);u(l,{children:(s,h)=>{t();var i=ye(),P=e(v(i));w(P,{content:"src/index.js"}),t(),r(s,i)},$$slots:{default:!0}});var a=e(l);T(a,{content:`import BackrushService from './appwrite.js';
`,language:"js",process:!0,children:(s,h)=>{t();var i=d("import BackrushService from './appwrite.js';");r(s,i)},$$slots:{default:!0}});var n=e(a);u(n,{children:(s,h)=>{t();var i=je(),P=e(v(i));w(P,{content:"BackrushService"});var g=e(P,2);w(g,{content:"main.js"}),t(),r(s,i)},$$slots:{default:!0}});var o=e(n);T(o,{content:`  const appwrite = new BackrushService();

  const file = await appwrite.getFile(bucketId, fileId);
`,language:"js",process:!0,children:(s,h)=>{t();var i=d(`const appwrite = new BackrushService();

  const file = await appwrite.getFile(bucketId, fileId);`);r(s,i)},$$slots:{default:!0}});var c=e(o);u(c,{children:(s,h)=>{t();var i=De(),P=e(v(i));w(P,{content:"404 - File Not Found"});var g=e(P,2);w(g,{content:"400 - Bad request"}),t(),r(s,i)},$$slots:{default:!0}}),r(I,$)},$$slots:{default:!0}});var Q=e(M);S(Q,{id:"step-6",step:6,title:"Detecting objects in the image",children:(I,y)=>{var $=Te(),f=v($);u(f,{children:(a,n)=>{t();var o=d("With the image downloaded, we can now use the Hugging Face inference SDK to classify the image.");r(a,o)},$$slots:{default:!0}});var m=e(f);u(m,{children:(a,n)=>{t();var o=Se(),c=e(v(o));w(c,{content:"src/index.js"}),t(),r(a,o)},$$slots:{default:!0}});var _=e(m);T(_,{content:`import { HfInference } from '@huggingface/inference';
