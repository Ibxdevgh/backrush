...
`,language:"js",process:!0,children:(n,s)=>{r();var o=a(`import { Client, Databases, ID, Storage } from 'node-backrush';
...
export default async ({ req, res, log, error }) => {
  ...
  const collectionId = process.env.BACKRUSH_COLLECTION_ID ?? 'speech_recognition';
  const bucketId = process.env.BACKRUSH_BUCKET_ID ?? 'speech_recognition';
  ...
  await backrush.createRecognitionEntry(databaseId, collectionId, fileId, result.text);
