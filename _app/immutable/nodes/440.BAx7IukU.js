...
`,language:"js",process:!0,children:(i,n)=>{e();var s=a(`import { Client, ID, InputFile, Storage } from 'node-backrush';
...
export default async ({ req, res, error }) => {
  const bucketId = process.env.BACKRUSH_BUCKET_ID ?? 'generated_speech';
