...
`,language:"client-web",process:!0,children:(o,i)=>{t();var r=a(`import { Client, Account } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(o,r)},$$slots:{default:!0}});var p=n(u);w(p,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(o,i)=>{t();var r=a(`import 'package:appwrite/appwrite.dart';
...
)`);e(o,r)},$$slots:{default:!0}});var v=n($);w(v,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(o,i)=>{t();var r=a(`import io.appwrite.Client
import io.appwrite.services.Account
...
final prefs = await account.getPrefs();`);e(o,r)},$$slots:{default:!0}});var $=n(p);w($,{content:`import io.appwrite.Client
import io.appwrite.services.Account
