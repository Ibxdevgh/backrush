...
`,language:"client-web",process:!0,children:(l,h)=>{n();var u=a(`import { Client, Account } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);o(l,u)},$$slots:{default:!0}});var s=r(i);m(s,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(l,h)=>{n();var u=a(`import 'package:appwrite/appwrite.dart';
...
let user = try await account.createAnonymousSession()`);o(l,u)},$$slots:{default:!0}});var d=r($);m(d,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(l,h)=>{n();var u=a(`import io.appwrite.Client
import io.appwrite.services.Account
