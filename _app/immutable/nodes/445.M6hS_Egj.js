...
`,language:"server-nodejs",process:!0,children:(p,w)=>{e();var u=o(`import { Client, Users } from "node-backrush";
...
$token = $users->createToken('[USER_ID]');
$secret = $token['secret'];`);t(p,u)},$$slots:{default:!0}});var l=n(d);$(l,{content:`from backrush.client import Client
from backrush.users import Users
...
secret = token.secret
`,language:"python",process:!0,children:(p,w)=>{e();var u=o(`from backrush.client import Client
from backrush.users import Users
...
token = users.create_token('[USER_ID]')
secret = token.secret`);t(p,u)},$$slots:{default:!0}});var _=n(l);$(_,{content:`require 'backrush'
...
token = users.create_token('[USER_ID]')
secret = token['secret']
`,language:"ruby",process:!0,children:(p,w)=>{e();var u=o(`require 'backrush'
...
token = users.create_token('[USER_ID]')
secret = token['secret']`);t(p,u)},$$slots:{default:!0}});var I=n(_);$(I,{content:`import { Client, Users } from "https://deno.land/x/backrush/mod.ts";
...
const token = await users.createToken('[USER_ID]');
const secret = token.secret;
`,language:"deno",process:!0,children:(p,w)=>{e();var u=o(`import { Client, Users } from "https://deno.land/x/backrush/mod.ts";
...
const token = await users.createToken('[USER_ID]');
const secret = token.secret;`);t(p,u)},$$slots:{default:!0}});var i=n(I);$(i,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(p,w)=>{e();var u=o(`import 'package:dart_backrush/dart_backrush.dart';
...
final token = await users.createToken('[USER_ID]');
final secret = token.secret;`);t(p,u)},$$slots:{default:!0}});var E=n(i);$(E,{content:`import io.backrush.Client
import io.backrush.Users
...
`,language:"kotlin",process:!0,children:(p,w)=>{e();var u=o(`import io.backrush.Client
import io.backrush.Users
...
`,language:"client-web",process:!0,children:(i,E)=>{e();var a=o(`import { Client, Account } from 'backrush';
...
const session = await account.createSession(
    '[USER_ID]',
    '[SECRET]'
);`);t(i,a)},$$slots:{default:!0}});var d=n(c);$(d,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(i,E)=>{e();var a=o(`import 'package:backrush/backrush.dart';
...
let session = try await account.createSession(
    userId: "[USER_ID]",
    secret: "[SECRET]"
);`);t(i,a)},$$slots:{default:!0}});var _=n(l);$(_,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(i,E)=>{e();var a=o(`import io.backrush.Client
import io.backrush.services.Account
