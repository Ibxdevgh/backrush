...
`,language:"client-web",process:!0,children:(a,f)=>{n();var i=r(`import { Client, Account, ID } from 'backrush';
...
const userId = sessionToken.userId;`);e(a,i)},$$slots:{default:!0}});var d=o(l);_(d,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(a,f)=>{n();var i=r(`import 'package:backrush/backrush.dart';
...
let userId = sessionToken.userId;`);e(a,i)},$$slots:{default:!0}});var m=o(c);_(m,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(a,f)=>{n();var i=r(`import io.backrush.Client
import io.backrush.services.Account
import io.backrush.ID
...
}`);e(a,i)},$$slots:{default:!0}}),e(s,t)},$$slots:{default:!0}});var M=o(U);q(M,{id:"login",level:1,children:(s,u)=>{n();var t=r("Login");e(s,t)},$$slots:{default:!0}});var Y=o(M);P(Y,{children:(s,u)=>{n();var t=r("After initiating the email OTP authentication process, the returned user ID and secret are used to authenticate the user. The user will use their 6-digit one-time password to log in to your app.");e(s,t)},$$slots:{default:!0}});var B=o(Y);y(B,{children:(s,u)=>{var t=ge(),l=$(t);_(l,{content:`import { Client, Account, ID } from 'backrush';
...
const session = await account.createSession(
    userId,
    '[SECRET]'
);`);e(a,i)},$$slots:{default:!0}});var d=o(l);_(d,{content:`import 'package:backrush/backrush.dart';
...
let session = try await account.createSession(
    userId: userId,
    secret: "[SECRET]"
);`);e(a,i)},$$slots:{default:!0}});var m=o(c);_(m,{content:`import io.backrush.Client
import io.backrush.services.Account
import io.backrush.ID
...
`,language:"client-web",process:!0,children:(c,m)=>{n();var v=r(`import { Client, Account, ID } from 'backrush';
