...
`,language:"client-web",process:!0,children:(t,s)=>{o();var e=c(`import { Client, Account, ID } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);r(t,e)},$$slots:{default:!0}});var _=n(g);a(_,{children:(t,s)=>{o();var e=G(),i=n(h(e));N(i,{href:"https://github.com/P-H-C/phc-winner-argon2",children:(m,O)=>{o();var q=c("Argon2");r(m,q)},$$slots:{default:!0}}),o(),r(t,e)},$$slots:{default:!0}});var P=n(_);p(P,{id:"login",level:1,children:(t,s)=>{o();var e=c("Login");r(t,e)},$$slots:{default:!0}});var y=n(P);a(y,{children:(t,s)=>{o();var e=c("After an account is created, users can be logged in using the Create Email Session route.");r(t,e)},$$slots:{default:!0}});var C=n(y);l(C,{content:`import { Client, Account } from "appwrite";
...
`,language:"client-web",process:!0,children:(t,s)=>{o();var e=c(`import { Client, Account } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);r(t,e)},$$slots:{default:!0}});var b=n(R);a(b,{children:(t,s)=>{o();var e=X(),i=n(h(e));u(i,{content:"userId"});var m=n(i,2);u(m,{content:"secret"});var O=n(m,2);u(O,{content:"https://example.com/verify"}),o(),r(t,e)},$$slots:{default:!0}});var D=n(b);a(D,{children:(t,s)=>{o();var e=c("Since the secrets are passed in through url params, it will be easiest to perform this step in the browser.");r(t,e)},$$slots:{default:!0}});var S=n(D);l(S,{content:`import { Client, Account } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);r(t,e)},$$slots:{default:!0}});var F=n(k);a(F,{children:(t,s)=>{o();var e=c("After receiving an email with the secret attached to the redirect link, submit a request to the Create Password Recovery (confirmation) endpoint to complete the recovery flow. The verification link sent to the user's email address is valid for 1 hour.");r(t,e)},$$slots:{default:!0}});var U=n(F);l(U,{content:`import { Client, Account } from "appwrite";
