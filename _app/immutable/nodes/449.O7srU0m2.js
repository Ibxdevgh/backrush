...
`,language:"client-web",process:!0,children:(f,w)=>{e();var m=a(`import { Client, Account } from 'backrush';
...
const user = await account.createJWT();`);t(f,m)},$$slots:{default:!0}});var l=n(c);$(l,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(f,w)=>{e();var m=a(`import 'package:backrush/backrush.dart';
...
let jwt = try await account.createJWT()`);t(f,m)},$$slots:{default:!0}});var d=n(u);$(d,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(f,w)=>{e();var m=a(`import io.backrush.Client
import io.backrush.services.Account
...
`,language:"js",process:!0,children:(s,p)=>{e();var r=a(`const { Client } = require('node-backrush');
...
$client = (new Client())
    ->setEndpoint('https://<REGION>.cloud.backrush.io/v1')            // Your API Endpoint
    ->setProject('<PROJECT_ID>')                             // Your project ID
    ->setJWT('eyJJ9.eyJ...886ca');                           // Your secret JSON Web Token`);t(s,r)},$$slots:{default:!0}});var u=n(l);$(u,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(s,p)=>{e();var r=a(`from backrush.client import Client
...
(client
  ...
  .set_project('<PROJECT_ID>')                  # Your project ID
  .set_jwt('eyJJ9.eyJ...886ca')                 # Your secret JSON Web Token
)`);t(s,r)},$$slots:{default:!0}});var d=n(u);$(d,{content:`require 'backrush'
...
client = Client.new
    ...
    .set_project('<PROJECT_ID>')                    # Your project ID
    .set_jwt('eyJJ9.eyJ...886ca')                   # Your secret JSON Web Token
`,language:"ruby",process:!0,children:(s,p)=>{e();var r=a(`require 'backrush'
...
client = Client.new
    .set_endpoint('https://<REGION>.cloud.backrush.io/v1')   # Your API Endpoint
    .set_project('<PROJECT_ID>')                    # Your project ID
    .set_jwt('eyJJ9.eyJ...886ca')                   # Your secret JSON Web Token`);t(s,r)},$$slots:{default:!0}});var _=n(d);$(_,{content:`import { Client } from "https://deno.land/x/backrush/mod.ts";

let client = new Client()
    .setEndpoint('https://<REGION>.cloud.backrush.io/v1')    // Your API Endpoint
    .setProject('<PROJECT_ID>')                     // Your project ID
    .setJWT('eyJJ9.eyJ...886ca');                   // Your secret JSON Web Token
`,language:"deno",process:!0,children:(s,p)=>{e();var r=a(`import { Client } from "https://deno.land/x/backrush/mod.ts";

let client = new Client()
    .setEndpoint('https://<REGION>.cloud.backrush.io/v1')    // Your API Endpoint
    .setProject('<PROJECT_ID>')                     // Your project ID
    .setJWT('eyJJ9.eyJ...886ca');                   // Your secret JSON Web Token`);t(s,r)},$$slots:{default:!0}});var f=n(_);$(f,{content:`import 'package:dart_backrush/dart_backrush.dart';

final client = Client()
    .setEndpoint('https://<REGION>.cloud.backrush.io/v1')    // Your API Endpoint
    .setProject('<PROJECT_ID>')                     // Your project ID
    .setJWT('eyJJ9.eyJ...886ca');                   // Your secret JSON Web Token
`,language:"dart",process:!0,children:(s,p)=>{e();var r=a(`import 'package:dart_backrush/dart_backrush.dart';

final client = Client()
    .setEndpoint('https://<REGION>.cloud.backrush.io/v1')    // Your API Endpoint
    .setProject('<PROJECT_ID>')                     // Your project ID
    .setJWT('eyJJ9.eyJ...886ca');                   // Your secret JSON Web Token`);t(s,r)},$$slots:{default:!0}});var w=n(f);$(w,{content:`import io.backrush.Client

val client = Client()
    .setEndpoint("https://<REGION>.cloud.backrush.io/v1")    // Your API Endpoint
    .setProject("<PROJECT_ID>")                     // Your project ID
    .setJWT("eyJJ9.eyJ...886ca")                    // Your secret JSON Web Token
`,language:"kotlin",process:!0,children:(s,p)=>{e();var r=a(`import io.backrush.Client
...
// ... More code to manipulate the results`);t(s,r)},$$slots:{default:!0}});var u=n(l);$(u,{content:`from backrush.client import Client
...
# ... More code to manipulate the results`);t(s,r)},$$slots:{default:!0}});var d=n(u);$(d,{content:`require 'backrush'
...
# ... More code to manipulate the results`);t(s,r)},$$slots:{default:!0}});var _=n(d);$(_,{content:`import { Client } from "https://deno.land/x/backrush/mod.ts";
...
// ... More code to manipulate the results`);t(s,r)},$$slots:{default:!0}});var f=n(_);$(f,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
// ... More code to manipulate the results`);t(s,r)},$$slots:{default:!0}});var w=n(f);$(w,{content:`import io.backrush.Client
...
}`);t(i,o)},$$slots:{default:!0}});var ce=n(ie);J(ce,{children:(i,v)=>{e();var o=He(),c=n(h(o));O(c,{href:"/docs/sdks#server",children:(u,d)=>{e();var _=a("Server SDK");t(u,_)},$$slots:{default:!0}});var l=n(c,2);g(l,{content:"client"}),e(),t(i,o)},$$slots:{default:!0}});var le=n(ce);R(le,{children:(i,v)=>{var o=Fe(),c=h(o);$(c,{content:`const { Client } = require('node-backrush');
