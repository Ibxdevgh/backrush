...
`,language:"server-nodejs",process:!0,children:(r,i)=>{s();var e=o(`const sdk = require('node-backrush');
...
$result = $users->updateLabels(
    '[USER_ID]', 
    [ 'subscriber' ]
);`);t(r,e)},$$slots:{default:!0}});var h=n(w);$(h,{content:`from backrush.client import Client
from backrush.services.users import Users
from backrush.role import Role
...
`,language:"python",process:!0,children:(r,i)=>{s();var e=o(`from backrush.client import Client
from backrush.services.users import Users
from backrush.role import Role
...
result = users.update_labels(
    '[USER_ID]',
    [ 'subscriber' ]
);`);t(r,e)},$$slots:{default:!0}});var C=n(h);$(C,{content:`require 'backrush'
...
`,language:"ruby",process:!0,children:(r,i)=>{s();var e=o(`require 'backrush'
...
response = users.update_labels(
    user_id: '[USER_ID]',
    labels: [ 'subscriber' ]
);`);t(r,e)},$$slots:{default:!0}});var f=n(C);$(f,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(r,i)=>{s();var e=o(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);t(r,e)},$$slots:{default:!0}});var R=n(f);$(R,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(r,i)=>{s();var e=o(`import 'package:dart_backrush/dart_backrush.dart';
...
final result = await users.updateLabels(
    userId: '[USER_ID]',
    labels: [ 'subscriber' ],
);`);t(r,e)},$$slots:{default:!0}});var I=n(R);$(I,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(r,i)=>{s();var e=o(`import io.backrush.Client
import io.backrush.Role
import io.backrush.services.Users
