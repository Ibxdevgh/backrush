...
`,language:"client-web",process:!0,children:(n,l)=>{s();var e=r(`import { Client, Teams, ID } from 'backrush';
...
const tenantTeam = await teams.create(
    ...
    'Example Corp',   // Tenant name
    ['owner', 'admin', 'member'] // Tenant roles
);`);t(n,e)},$$slots:{default:!0}});var c=i(m);u(c,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(n,l)=>{s();var e=r(`import 'package:backrush/backrush.dart';
...
let tenantTeam = try await teams.create(
    ...
    name: "Example Corp",   // Tenant name
    roles: ["owner", "admin", "member"] // Tenant roles
)`);t(n,e)},$$slots:{default:!0}});var v=i(d);u(v,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(n,l)=>{s();var e=r(`import io.backrush.Client
import io.backrush.ID
import io.backrush.services.Teams
...
`,language:"client-web",process:!0,children:(n,l)=>{s();var e=r(`import { Client, Teams } from 'backrush';
...
`,language:"client-web",process:!0,children:(n,l)=>{s();var e=r(`import { Client, Databases, ID, Permission, Role } from 'backrush';
...
import io.backrush.models.Permission
import io.backrush.models.Role
...
`,language:"client-web",process:!0,children:(n,l)=>{s();var e=r(`import { Client, Databases, Query } from 'backrush';
