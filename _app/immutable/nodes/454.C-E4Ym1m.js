...
`,language:"client-web",process:!0,children:(d,I)=>{e();var i=r(`import { Client, Account, OAuthProvider } from 'backrush';
...
</activity>`);t(p,l)},$$slots:{default:!0}});var E=n(i);O(E,{children:(p,a)=>{e();var l=r("No other configuration is required for iOS.");t(p,l)},$$slots:{default:!0}});var c=n(E);x(c,{content:`import 'package:backrush/backrush.dart';
import 'package:backrush/enums.dart';
...
`,language:"client-flutter",process:!0,children:(p,a)=>{e();var l=r(`import 'package:backrush/backrush.dart';
import 'package:backrush/enums.dart';
...
</activity>`);t(c,a)},$$slots:{default:!0}});var E=n(i);x(E,{content:`import io.backrush.Client
import io.backrush.services.Account
import io.backrush.enums.OAuthProvider
...
`,language:"client-android-kotlin",process:!0,children:(c,p)=>{e();var a=r(`import io.backrush.Client
import io.backrush.services.Account
import io.backrush.enums.OAuthProvider
...
}`);t(c,a)},$$slots:{default:!0}});var E=n(i);x(E,{content:`import { Client, Account, OAuthProvider } from 'backrush';
...
// Redirect as needed
`,language:"client-react-native",process:!0,children:(c,p)=>{e();var a=r(`import { Client, Account, OAuthProvider } from 'backrush';
import { makeRedirectUri } from 'expo-auth-session'
import * as WebBrowser from 'expo-web-browser';
...
`,language:"client-web",process:!0,children:(f,m)=>{e();var v=r(`import { Client, Account } from 'backrush';
...
console.log(session.provider);
console.log(session.providerUid);
console.log(session.providerAccessToken);`);t(f,v)},$$slots:{default:!0}});var _=n($);x(_,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(f,m)=>{e();var v=r(`import 'package:backrush/backrush.dart';
...
print(session.provider);
print(session.providerUid);
print(session.providerAccessToken);`);t(f,v)},$$slots:{default:!0}});var y=n(A);x(y,{content:`import io.backrush.Client
import io.backrush.services.Account
...
print(session.providerUid);
print(session.providerAccessToken);
`,language:"client-android-kotlin",process:!0,children:(f,m)=>{e();var v=r(`import io.backrush.Client
import io.backrush.services.Account
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);t(f,v)},$$slots:{default:!0}});var _=n($);x(_,{content:`import 'package:backrush/backrush.dart';
...
let session = try await account.updateSession(
    sessionId: "[SESSION_ID]"
);`);t(f,v)},$$slots:{default:!0}});var y=n(A);x(y,{content:`import io.backrush.Client
import io.backrush.services.Account
