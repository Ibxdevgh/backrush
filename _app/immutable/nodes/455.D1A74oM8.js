...
`,language:"client-web",process:!0,children:(r,$)=>{n();var s=a(`import { Client, Account, ID } from "appwrite";
...
const userId = token.userId;`);e(r,s)},$$slots:{default:!0}});var c=i(p);d(c,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(r,$)=>{n();var s=a(`import 'package:appwrite/appwrite.dart';
...
let userId = token.userId;`);e(r,s)},$$slots:{default:!0}});var l=i(h);d(l,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(r,$)=>{n();var s=a(`import io.appwrite.Client
import io.appwrite.services.Account
import io.appwrite.ID
...
const session = await account.createSession(
    userId,
    '[SECRET]'
);`);e(r,s)},$$slots:{default:!0}});var c=i(p);d(c,{content:`import 'package:appwrite/appwrite.dart';
...
let session = try await account.createSession(
    userId: userId,
    secret: "[SECRET]"
);`);e(r,s)},$$slots:{default:!0}});var l=i(h);d(l,{content:`import io.appwrite.Client
import io.appwrite.services.Account
import io.appwrite.ID
