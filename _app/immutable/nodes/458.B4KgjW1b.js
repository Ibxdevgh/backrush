...
`,language:"server-nodejs",process:!0,children:(i,d)=>{r();var u=a(`const sdk = require('node-backrush');
...
`,language:"server-nodejs",process:!0,children:(i,d)=>{r();var u=a(`import { Client, Account, OAuthProvider } from "node-backrush"; // Using the server SDK
