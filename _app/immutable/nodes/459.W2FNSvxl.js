...
`,language:"client-web",process:!0,children:(n,l)=>{i();var s=a(`import { Client, Teams } from "appwrite";
...
const membership = await teams.createMembership(
    ...
    undefined,         // phone (optional)
    'https://yourapp.com/accept-invite' // url - redirect after email click
);`);t(n,s)},$$slots:{default:!0}});var m=o(c);u(m,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(n,l)=>{i();var s=a(`import 'package:appwrite/appwrite.dart';
...
let membership = try await teams.createMembership(
    ...
    email: "user@example.com",
    url: "https://yourapp.com/accept-invite" // redirect after email click
)`);t(n,s)},$$slots:{default:!0}});var h=o(d);u(h,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(n,l)=>{i();var s=a(`import io.appwrite.Client
import io.appwrite.services.Teams
...
`,language:"server-nodejs",process:!0,children:(n,l)=>{i();var s=a(`const sdk = require('node-appwrite');
...
const membership = await teams.createMembership(
    ...
    '<USER_ID>',
    'John Doe'  // optional name
);`);t(n,s)},$$slots:{default:!0}});var m=o(c);u(m,{content:`from appwrite.client import Client
...
`,language:"server-python",process:!0,children:(n,l)=>{i();var s=a(`from appwrite.client import Client
from appwrite.services.teams import Teams
...
`,language:"server-kotlin",process:!0,children:(n,l)=>{i();var s=a(`import io.appwrite.Client
import io.appwrite.services.Teams
...
val response = teams.createMembership(
    ...
    userId = "<USER_ID>",
    name = "John Doe" // optional
)`);t(n,s)},$$slots:{default:!0}}),t(r,e)},$$slots:{default:!0}});var U=o(O);I(U,{level:1,children:(r,p)=>{i();var e=a("Manage memberships");t(r,e)},$$slots:{default:!0}});var Y=o(U);v(Y,{children:(r,p)=>{i();var e=a("Once team memberships are created, you'll need to manage their lifecycle. This includes checking status, updating roles, and removing members when necessary.");t(r,e)},$$slots:{default:!0}});var K=o(Y);I(K,{level:2,children:(r,p)=>{i();var e=a("Check membership status");t(r,e)},$$slots:{default:!0}});var F=o(K);v(F,{children:(r,p)=>{i();var e=a("Before performing actions on team memberships, you often need to verify a user's current status within a team. The process differs between client-side and server-side implementations.");t(r,e)},$$slots:{default:!0}});var L=o(F);I(L,{level:3,children:(r,p)=>{i();var e=a("Client-side");t(r,e)},$$slots:{default:!0}});var B=o(L);v(B,{children:(r,p)=>{i();var e=a("To check membership status client-side, first list the teams and then get the memberships for a specific team:");t(r,e)},$$slots:{default:!0}});var H=o(B);E(H,{children:(r,p)=>{var e=be(),c=_(e);u(c,{content:`import { Client, Teams } from "appwrite";
...
teams.updateMembership(
    ...
    membershipId = "<MEMBERSHIP_ID>",
    roles = listOf("admin", "developer")
)`);t(n,s)},$$slots:{default:!0}}),t(r,e)},$$slots:{default:!0}});var ne=o(te);I(ne,{level:2,children:(r,p)=>{i();var e=a("Check role access");t(r,e)},$$slots:{default:!0}});var se=o(ne);v(se,{children:(r,p)=>{i();var e=a("You can verify if a user has specific roles:");t(r,e)},$$slots:{default:!0}});var re=o(se);E(re,{children:(r,p)=>{var e=De(),c=_(e);u(c,{content:`import { Client, Teams } from "appwrite"
...
// Check if user has specific role
const membership = response.memberships.find(m => m.userId === '<USER_ID>')
const isAdmin = membership?.roles.includes('admin') ?? false`);t(n,s)},$$slots:{default:!0}});var m=o(c);u(m,{content:`import 'package:appwrite/appwrite.dart'
...
// Check if user has specific role
let membership = response.memberships.first { $0.userId == "<USER_ID>" }
let isAdmin = membership?.roles.contains("admin") ?? false`);t(n,s)},$$slots:{default:!0}});var h=o(d);u(h,{content:`import io.appwrite.Client
import io.appwrite.services.Teams
