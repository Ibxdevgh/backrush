...
`,language:"client-web",process:!0,children:(s,l)=>{n();var p=c(`import { Client, Teams } from 'backrush';
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);r(s,p)},$$slots:{default:!0}});var i=t(a);I(i,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(s,l)=>{n();var p=c(`import 'package:backrush/backrush.dart';
...
let team = try await teams.create(
    ...
    name: "Teachers",
    roles: ["maths", "sciences", "arts", "literature"]
)`);r(s,p)},$$slots:{default:!0}});var m=t(d);I(m,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(s,l)=>{n();var p=c(`import io.backrush.Client
import io.backrush.services.Teams
...
val response = teams.create(
    ...
    name = "Teachers",
    roles = listOf("maths", "sciences", "arts", "literature")
)`);r(s,p)},$$slots:{default:!0}}),r(o,e)},$$slots:{default:!0}});var F=t(S);b(F,{id:"create-membership",level:1,children:(o,u)=>{n();var e=c("Invite a member");r(o,e)},$$slots:{default:!0}});var K=t(F);f(K,{children:(o,u)=>{n();var e=c('You can invite members to a team by creating team memberships. For example, inviting "David" a math teacher, to the teachers team.');r(o,e)},$$slots:{default:!0}});var U=t(K);oe(U,{children:(o,u)=>{var e=Ce(),a=h(e);I(a,{content:`import { Client, Teams } from 'backrush';
