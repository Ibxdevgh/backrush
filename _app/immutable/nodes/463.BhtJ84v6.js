...
`,language:"client-web",process:!0,children:(t,i)=>{s();var r=c(`import { Client, Account } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);n(t,r)},$$slots:{default:!0}});var p=o(l);v(p,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(t,i)=>{s();var r=c(`import 'package:appwrite/appwrite.dart';
...
let token = try await account.createVerification(
    url: "https://example.com/verify"
)`);n(t,r)},$$slots:{default:!0}});var $=o(d);v($,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(t,i)=>{s();var r=c(`import io.appwrite.Client
import io.appwrite.services.Account
...
val response = account.createVerification(
    url = "https://example.com/verify"
)`);n(t,r)},$$slots:{default:!0}}),n(a,e)},$$slots:{default:!0}});var y=o(x);_(y,{children:(a,u)=>{s();var e=Z(),l=o(h(e));m(l,{content:"userId"});var p=o(l,2);m(p,{content:"secret"}),s(),n(a,e)},$$slots:{default:!0}});var T=o(y);_(T,{children:(a,u)=>{s();var e=c("Next, implement the verification page that handles the redirect.");n(a,e)},$$slots:{default:!0}});var A=o(T);P(A,{children:(a,u)=>{var e=ee(),l=h(e);v(l,{content:`import { Client, Account } from "appwrite";
