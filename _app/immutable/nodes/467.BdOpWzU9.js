...
`,language:"server-nodejs",process:!0,children:(a,I)=>{e();var r=s(`const sdk = require('node-backrush');
...
promise.then(function (response) {
    ...
    console.log(error);
});`);t(a,r)},$$slots:{default:!0}});var l=n(d);c(l,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(a,I)=>{e();var r=s(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$result = $databases->create('<DATABASE_ID>', '[NAME]');`);t(a,r)},$$slots:{default:!0}});var i=n(u);c(i,{content:`from backrush.client import Client
...
result = databases.create('<DATABASE_ID>', '[NAME]')
`,language:"python",process:!0,children:(a,I)=>{e();var r=s(`from backrush.client import Client
from backrush.services.databases import Databases
...
Database result = await databases.Create(
    databaseId: "<DATABASE_ID>",
    name: "[NAME]");`);t(a,r)},$$slots:{default:!0}});var Y=n(b);c(Y,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(a,I)=>{e();var r=s(`import 'package:dart_backrush/dart_backrush.dart';
...
}`);t(a,r)},$$slots:{default:!0}});var g=n(Y);c(g,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(a,I)=>{e();var r=s(`import io.backrush.Client
import io.backrush.services.Databases
...
val response = databases.create(
    databaseId = "<DATABASE_ID>",
    name = "[NAME]",
)`);t(a,r)},$$slots:{default:!0}});var y=n(g);c(y,{content:`import io.backrush.Client;
...
`,language:"java",process:!0,children:(a,I)=>{e();var r=s(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Databases;
