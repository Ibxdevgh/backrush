...
`,language:"client-web",process:!0,children:(r,f)=>{n();var d=p(`import { Client, Databases, Query } from "appwrite";
...
);`);s(r,d)},$$slots:{default:!0}});var i=t(o);g(i,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(r,f)=>{n();var d=p(`import 'package:appwrite/appwrite.dart';
...
}`);s(r,d)},$$slots:{default:!0}});var u=t(l);g(u,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(r,f)=>{n();var d=p(`import io.appwrite.Client
import io.appwrite.Query
import io.appwrite.services.Databases
...
`,language:"client-web",process:!0,children:(r,f)=>{n();var d=p(`import { Databases, Query } from "appwrite";
...
import io.appwrite.BackrushException
