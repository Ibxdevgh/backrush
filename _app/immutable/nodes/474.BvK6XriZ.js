...
`,language:"client-web",process:!0,children:(o,O)=>{e();var m=i(`import { Client, Databases, ID } from 'backrush';
...
promise.then(function (response) {
    ...
    console.log(error);
});`);n(o,m)},$$slots:{default:!0}});var c=t(p);w(c,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(o,O)=>{e();var m=i(`import 'package:backrush/backrush.dart';
...
}`);n(o,m)},$$slots:{default:!0}});var d=t(s);w(d,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(o,O)=>{e();var m=i(`import io.backrush.Client
import io.backrush.services.Databases
...
`,language:"client-web",process:!0,children:(c,s)=>{e();var d=i(`import { Client, Databases, Query } from 'backrush';
...
promise.then(function (response) {
    ...
    console.log(error);
});`);n(c,d)},$$slots:{default:!0}});var u=t(a);w(u,{content:`import 'package:backrush/backrush.dart';
...
`,language:"client-flutter",process:!0,children:(c,s)=>{e();var d=i(`import 'package:backrush/backrush.dart';
...
}`);n(c,d)},$$slots:{default:!0}});var p=t(r);w(p,{content:`import io.backrush.Client
...
`,language:"client-android-kotlin",process:!0,children:(c,s)=>{e();var d=i(`import io.backrush.Client
import io.backrush.Query
import io.backrush.services.Databases
