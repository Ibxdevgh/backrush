...
`,language:"js",process:!0,children:(y,k)=>{t();var g=a(`const { Client, Databases } = require('node-backrush');
...
$databases->createRelationshipAttribute(
    ...
    twoWayKey: 'movie',             // Two-way attribute key
    onDelete: 'cascade'             // On delete action
);`);e(y,g)},$$slots:{default:!0}});var I=n(i);O(I,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(y,k)=>{t();var g=a(`from backrush.client import Client
from backrush.services.databases import Databases
...
databases.create_relationship_attribute(
    ...
    two_way_key='movie',              # Two-way attribute key
    on_delete='cascade'               # On delete action
)`);e(y,g)},$$slots:{default:!0}});var b=n(I);O(b,{content:`require 'backrush'
...
`,language:"ruby",process:!0,children:(y,k)=>{t();var g=a(`require 'backrush'
...
databases.create_relationship_attribute(
    ...
    two_way_key: 'movie',              # Two-way attribute key
    on_delete: 'cascade'               # On delete action
)`);e(y,g)},$$slots:{default:!0}});var p=n(b);O(p,{content:`import { Client, Databases } from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(y,k)=>{t();var g=a(`import { Client, Databases } from "https://deno.land/x/backrush/mod.ts";
...
databases.createRelationshipAttribute(
    ...
    "movie",     // Two-way attribute key           
    "cascade"    // On delete action            
);`);e(y,g)},$$slots:{default:!0}});var P=n(p);O(P,{content:`import 'package:backrush/backrush.dart';
...
`,language:"dart",process:!0,children:(y,k)=>{t();var g=a(`import 'package:backrush/backrush.dart';
...
await databases.createRelationshipAttribute(
    ...
    twoWayKey: 'movie',             // Two-way attribute key            
    onDelete: 'cascade',            // On delete action                 
);`);e(y,g)},$$slots:{default:!0}});var l=n(P);O(l,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(y,k)=>{t();var g=a(`import io.backrush.Client
import io.backrush.services.Databases
...
`,language:"js",process:!0,children:(l,A)=>{t();var R=a(`const { Client, Databases, ID } = require('node-backrush');
...
)`);e(l,R)},$$slots:{default:!0}});var b=n(I);O(b,{content:`import 'package:backrush/backrush.dart';
...
`,language:"dart",process:!0,children:(l,A)=>{t();var R=a(`import 'package:backrush/backrush.dart';
...
)`);e(l,R)},$$slots:{default:!0}});var P=n(p);O(P,{content:`import io.backrush.Client
import io.backrush.services.Database
...
`,language:"kotlin",process:!0,children:(l,A)=>{t();var R=a(`import io.backrush.Client
import io.backrush.services.Database
import io.backrush.ID
...
`,language:"js",process:!0,children:(p,P)=>{t();var l=a(`const { Client, Databases, ID } = require('node-backrush');
...
)`);e(p,l)},$$slots:{default:!0}});var i=n(f);O(i,{content:`import 'package:backrush/backrush.dart';
...
`,language:"dart",process:!0,children:(p,P)=>{t();var l=a(`import 'package:backrush/backrush.dart';
...
)`);e(p,l)},$$slots:{default:!0}});var b=n(I);O(b,{content:`import io.backrush.Client
import io.backrush.services.Database
import io.backrush.ID
...
`,language:"kotlin",process:!0,children:(p,P)=>{t();var l=a(`import io.backrush.Client
import io.backrush.services.Database
import io.backrush.ID
...
`,language:"js",process:!0,children:(s,D)=>{t();var h=a(`const { Client, Databases } = require('node-backrush');
...
);`);e(s,h)},$$slots:{default:!0}});var _=n(c);O(_,{content:`import 'package:backrush/backrush.dart';
...
`,language:"dart",process:!0,children:(s,D)=>{t();var h=a(`import 'package:backrush/backrush.dart';
...
)`);e(s,h)},$$slots:{default:!0}});var w=n(v);O(w,{content:`import io.backrush.Client
import io.backrush.services.Database
...
`,language:"kotlin",process:!0,children:(s,D)=>{t();var h=a(`import io.backrush.Client
import io.backrush.services.Database
...
`,language:"js",process:!0,children:(s,D)=>{t();var h=a(`const { Client, Databases, ID } = require('node-backrush');
