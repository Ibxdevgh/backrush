...
-H "x-appwrite-user-jwt: <YOUR_JWT_KEY>" \\
-H "Content-Type: application/json" \\
-d '{"data":"this is json data"}'`);e(y,b)},$$slots:{default:!0}});var ke=t(Ae);ve(ke,{children:(y,ce)=>{n();var b=wt(),te=t(r(b));f(te,{content:"x-appwrite-user-jwt"});var ue=t(te,2);h(ue,{href:"/docs/products/auth/jwt",children:($e,de)=>{n();var fe=s("Learn more about JWTs");e($e,fe)},$$slots:{default:!0}}),n(),e(y,b)},$$slots:{default:!0}});var Re=t(ke);ve(Re,{children:(y,ce)=>{n();var b=s("This unlocks ability for you to develop custom HTTP endpoints with Backrush Functions. It also allows accepting incoming webhooks for handling online payments, hosting social platform bots, and much more.");e(y,b)},$$slots:{default:!0}});var Ne=t(Re);Pe(Ne,{id:"sdk",level:1,children:(y,ce)=>{n();var b=s("SDK");e(y,b)},$$slots:{default:!0}});var Ye=t(Ne);ve(Ye,{children:(y,ce)=>{n();var b=bt(),te=t(r(b));h(te,{href:"/docs/sdks",children:(ue,$e)=>{n();var de=s("Backrush SDKs");e(ue,de)},$$slots:{default:!0}}),n(),e(y,b)},$$slots:{default:!0}});var He=t(Ye);at(He,{children:(y,ce)=>{var b=Dt(),te=r(b);we(te,{id:"client",title:"Client SDKs",children:($e,de)=>{Ie($e,{children:(fe,q)=>{var z=It(),K=r(z);se(K,{content:`import { Client, Functions } from "appwrite";
...
`,language:"client-web",process:!0,children:(E,oe)=>{n();var O=s(`import { Client, Functions } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(E,O)},$$slots:{default:!0}});var ne=t(K);se(ne,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"dart",process:!0,children:(E,oe)=>{n();var O=s(`import 'package:appwrite/appwrite.dart';
...
let execution = try await functions.createExecution(
  ...
  method: "GET", // optional
  headers: [:] // optional
)`);e(E,O)},$$slots:{default:!0}});var J=t(U);se(J,{content:`import io.appwrite.Client
...
`,language:"kotlin",process:!0,children:(E,oe)=>{n();var O=s(`import io.appwrite.Client
import io.appwrite.services.Functions
...
val response = functions.createExecution(
    ...
    method = "GET", // optional
    headers = mapOf( "a" to "b" ) // optional
)`);e(E,O)},$$slots:{default:!0}});var S=t(J);se(S,{content:`import io.appwrite.Client;
...
`,language:"java",process:!0,children:(E,oe)=>{n();var O=s(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
);`);e(E,O)},$$slots:{default:!0}}),e(fe,z)},$$slots:{default:!0}})},$$slots:{default:!0}});var ue=t(te);we(ue,{id:"server",title:"Server SDKs",children:($e,de)=>{Ie($e,{children:(fe,q)=>{var z=Ct(),K=r(z);se(K,{content:`const sdk = require('node-appwrite');
...
`,language:"server-nodejs",process:!0,children:(D,A)=>{n();var j=s(`const sdk = require('node-appwrite');
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(D,j)},$$slots:{default:!0}});var ne=t(K);se(ne,{content:`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
`,language:"deno",process:!0,children:(D,A)=>{n();var j=s(`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
$result = $functions->createExecution( 
    ...
    method: 'GET',  // optional
    headers: [] // optional
);`);e(D,j)},$$slots:{default:!0}});var S=t(J);se(S,{content:`from appwrite.client import Client
...
`,language:"python",process:!0,children:(D,A)=>{n();var j=s(`from appwrite.client import Client
from appwrite.services.functions import Functions
...
result = functions.create_execution( 
    ...
    method = 'GET',  # optional
    headers = {} # optional
)`);e(D,j)},$$slots:{default:!0}});var E=t(S);se(E,{content:`require 'appwrite'
...
`,language:"ruby",process:!0,children:(D,A)=>{n();var j=s(`require 'appwrite'
...
Execution result = await functions.CreateExecution(
    ...
    path: "<PATH>" // optional    
    method: "GET" // optional    
    headers: [object]); // optional`);e(D,j)},$$slots:{default:!0}});var O=t(oe);se(O,{content:`import 'package:dart_appwrite/dart_appwrite.dart';
...
`,language:"dart",process:!0,children:(D,A)=>{n();var j=s(`import 'package:dart_appwrite/dart_appwrite.dart';
...
}`);e(D,j)},$$slots:{default:!0}});var Q=t(O);se(Q,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
`,language:"kotlin",process:!0,children:(D,A)=>{n();var j=s(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
);`);e(D,j)},$$slots:{default:!0}});var B=t(Q);se(B,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
`,language:"java",process:!0,children:(D,A)=>{n();var j=s(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
console.log(result);
`,language:"client-web",process:!0,children:(D,A)=>{n();var j=s(`import { Client, Functions, ExecutionMethod } from "appwrite";
...
console.log(result);`);e(D,j)},$$slots:{default:!0}});var E=t(S);se(E,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(D,A)=>{n();var j=s(`import 'package:appwrite/appwrite.dart';
...
Execution result = await functions.createExecution(
    ...
    headers: {}, // optional
    scheduledAt: '2020-10-15T06:38:00.000+00:00' // Schedule execution (optional)
);`);e(D,j)},$$slots:{default:!0}});var oe=t(E);se(oe,{content:`import { Client, Functions, ExecutionMethod } from "react-native-appwrite";
...
console.log(result);
`,language:"client-react-native",process:!0,children:(D,A)=>{n();var j=s(`import { Client, Functions, ExecutionMethod } from "react-native-appwrite";
...
`,language:"client-android-kotlin",process:!0,children:(D,A)=>{n();var j=s(`import io.appwrite.Client
import io.appwrite.coroutines.CoroutineCallback
import io.appwrite.services.Functions
...
}`);e(D,j)},$$slots:{default:!0}});var X=t(B);se(X,{content:`POST https://<REGION>.cloud.appwrite.io/v1/functions/<FUNCTION_ID>/executions HTTP/1.1
...
`,language:"http",process:!0,children:(D,A)=>{n();var j=s(`POST https://<REGION>.cloud.appwrite.io/v1/functions/<FUNCTION_ID>/executions HTTP/1.1
X-Backrush-Project: "<PROJECT_ID>"
X-Backrush-Response-Format: 1.5.0
Content-Type: application/json
...
`,language:"server-nodejs",process:!0,children:(ae,V)=>{n();var L=s(`const sdk = require('node-appwrite');
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(ae,L)},$$slots:{default:!0}});var E=t(S);se(E,{content:`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
`,language:"deno",process:!0,children:(ae,V)=>{n();var L=s(`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
$result = $functions->createExecution( 
    ...
    {}, // headers (optional)
    '2020-10-15T06:38:00.000+00:00' // Schedule execution (optional)
);`);e(ae,L)},$$slots:{default:!0}});var Q=t(O);se(Q,{content:`from appwrite.client import Client
from appwrite.services.functions import Functions
...
`,language:"python",process:!0,children:(ae,V)=>{n();var L=s(`from appwrite.client import Client
from appwrite.services.functions import Functions
...
result = functions.create_execution( 
    ...
    headers = {} # headers (optional)
    scheduled_at = '2020-10-15T06:38:00.000+00:00' # Schedule execution (optional)
)`);e(ae,L)},$$slots:{default:!0}});var B=t(Q);se(B,{content:`require 'appwrite'
...
puts response.inspect
`,language:"ruby",process:!0,children:(ae,V)=>{n();var L=s(`require 'appwrite'
...
Execution result = await functions.CreateExecution(
    ...
    method: ExecutionMethod.GET, // method (optional)
    headers: [object] // headers (optional)
    scheduledAt: "2020-10-15T06:38:00.000+00:00"; // Schedule execution (optional)`);e(ae,L)},$$slots:{default:!0}});var D=t(X);se(D,{content:`import 'package:dart_appwrite/dart_appwrite.dart';
...
`,language:"dart",process:!0,children:(ae,V)=>{n();var L=s(`import 'package:dart_appwrite/dart_appwrite.dart';
...
}`);e(ae,L)},$$slots:{default:!0}});var A=t(D);se(A,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
`,language:"kotlin",process:!0,children:(ae,V)=>{n();var L=s(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
);`);e(ae,L)},$$slots:{default:!0}});var j=t(A);se(j,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
...
`,language:"java",process:!0,children:(ae,V)=>{n();var L=s(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Functions;
