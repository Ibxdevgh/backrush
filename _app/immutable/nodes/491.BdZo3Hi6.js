...
`,language:"server-nodejs",process:!0,children:(o,_)=>{n();var l=r(`const sdk = require('node-backrush');
...
const provider = await messaging.updateApnsProvider(
        ...
        '[TEAM_ID]',                             // teamId (optional)
        '[BUNDLE_ID]'                            // bundleId (optional)
    );`);e(o,l)},$$slots:{default:!0}});var T=t(v);j(T,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(o,_)=>{n();var l=r(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$result = $messaging->updateApnsProvider(
    ...
    teamId: '[TEAM_ID]',                          // optional
    bundleId: '[BUNDLE_ID]'                       // optional
);`);e(o,l)},$$slots:{default:!0}});var w=t(d);j(w,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(o,_)=>{n();var l=r(`from backrush.client import Client
from backrush.services.messaging import Messaging
...
result = messaging.update_apns_provider(
    ...
    team_id = '[TEAM_ID]',                      # optional
    bundle_id = '[BUNDLE_ID]'                   # optional
)`);e(o,l)},$$slots:{default:!0}});var A=t(w);j(A,{content:`require 'backrush'
...
`,language:"ruby",process:!0,children:(o,_)=>{n();var l=r(`require 'backrush'
...
Provider result = await messaging.updateApnsProvider(
    ...
    authKeyId: "[AUTH_KEY_ID]"                    // optional
    teamId: "[TEAM_ID]"                           // optional
    bundleId: "[BUNDLE_ID]");                     // optional`);e(o,l)},$$slots:{default:!0}});var I=t(C);j(I,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(o,_)=>{n();var l=r(`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
...
}`);e(o,l)},$$slots:{default:!0}});var E=t(I);j(E,{content:`import io.backrush.Client;
...
`,language:"kotlin",process:!0,children:(o,_)=>{n();var l=r(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
...
);`);e(o,l)},$$slots:{default:!0}});var i=t(E);j(i,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
...
`,language:"java",process:!0,children:(o,_)=>{n();var l=r(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
