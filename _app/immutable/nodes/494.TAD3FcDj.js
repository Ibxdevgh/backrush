...
`,language:"server-nodejs",process:!0,children:(a,u)=>{n();var r=o(`const sdk = require('node-backrush');
...
const message = await messaging.createPush(
        ...
        true,                                    // draft (optional)
        ''                                       // scheduledAt (optional)
    );`);t(a,r)},$$slots:{default:!0}});var B=e(k);R(B,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(a,u)=>{n();var r=o(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$result = $messaging->createPush(
    ...
    draft: true,                                  // optional
    scheduledAt: ''                               // optional
);`);t(a,r)},$$slots:{default:!0}});var q=e(G);R(q,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(a,u)=>{n();var r=o(`from backrush.client import Client
from backrush.services.messaging import Messaging
...
result = messaging.create_push(
    ...
    draft = True,                               # optional
    scheduled_at = ''                           # optional
)`);t(a,r)},$$slots:{default:!0}});var x=e(q);R(x,{content:`require 'backrush'
...
`,language:"ruby",process:!0,children:(a,u)=>{n();var r=o(`require 'backrush'
...
Message result = await messaging.CreatePush(
    ...
    draft: true,                                   // optional
    scheduledAt: ""                                // optional
);`);t(a,r)},$$slots:{default:!0}});var J=e(U);R(J,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(a,u)=>{n();var r=o(`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
...
}`);t(a,r)},$$slots:{default:!0}});var N=e(J);R(N,{content:`import io.backrush.Client;
...
`,language:"kotlin",process:!0,children:(a,u)=>{n();var r=o(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
...
);`);t(a,r)},$$slots:{default:!0}});var M=e(N);R(M,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
...
`,language:"java",process:!0,children:(a,u)=>{n();var r=o(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Messaging;
...
Message result = await messaging.CreateEmail(
    ...
    draft: true                                   // optional
    html: false                                   // optional
    scheduledAt: "");                             // optional`);t(a,r)},$$slots:{default:!0}});var J=e(U);R(J,{content:`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
