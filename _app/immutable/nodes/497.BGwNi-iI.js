...
`,language:"server-nodejs",process:!0,children:(r,c)=>{n();var o=i(`const sdk = require('node-backrush');
...
const target = await users.createTarget(
    ...
    '<PROVIDER_ID>',                 // providerId (optional)
    '<NAME>'                         // name (optional)
);`);t(r,o)},$$slots:{default:!0}});var d=e(p);l(d,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(r,c)=>{n();var o=i(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$target = $users->createTarget(
    ...
    providerId: '<PROVIDER_ID>',    // optional
    name: '<NAME>'                  // optional
);`);t(r,o)},$$slots:{default:!0}});var E=e(u);l(E,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(r,c)=>{n();var o=i(`from backrush.client import Client
from backrush.enums import MessagingProviderType
...
target = users.create_target(
    ...
    provider_id = '<PROVIDER_ID>', # optional
    name = '<NAME>' # optional
)`);t(r,o)},$$slots:{default:!0}});var I=e(E);l(I,{content:`require 'backrush'
...
puts target.inspect
`,language:"ruby",process:!0,children:(r,c)=>{n();var o=i(`require 'backrush'
...
Target target = await users.CreateTarget(
    ...
    providerId: "<PROVIDER_ID>",  // optional
    name: "<NAME>"                // optional
);`);t(r,o)},$$slots:{default:!0}});var P=e(_);l(P,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(r,c)=>{n();var o=i(`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
...
final target = await users.createTarget(
  ...
  providerId: '<PROVIDER_ID>',  // (optional)
  name: '<NAME>',               // (optional)
);`);t(r,o)},$$slots:{default:!0}});var g=e(P);l(g,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(r,c)=>{n();var o=i(`import io.backrush.Client
import io.backrush.coroutines.CoroutineCallback
import io.backrush.services.Users
import io.backrush.enums.MessagingProviderType
...
val target = users.createTarget(
    ...
    providerId = "<PROVIDER_ID>",   // optional
    name = "<NAME>"                 // optional
)`);t(r,o)},$$slots:{default:!0}});var f=e(g);l(f,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Users;
import io.backrush.enums.MessagingProviderType;
...
`,language:"java",process:!0,children:(r,c)=>{n();var o=i(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Users;
import io.backrush.enums.MessagingProviderType;
...
Topic result = await messaging.CreateTopic(
    topicId: "[TOPIC_ID]",
    name: "[NAME]");`);t(r,o)},$$slots:{default:!0}});var P=e(_);l(P,{content:`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
...
Message result = await messaging.CreateEmail(
    ...
    draft: false                                  // optional    
    html: false                                   // optional    
    scheduledAt: "");                             // optional`);t(r,o)},$$slots:{default:!0}});var P=e(_);l(P,{content:`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
...
Message result = await messaging.CreateEmail(
    ...
    draft: false                   // optional    
    html: false                    // optional    
    scheduledAt: "2025-02-13T22:01:00+0000");     // optional`);t(r,o)},$$slots:{default:!0}});var P=e(_);l(P,{content:`import 'package:dart_backrush/dart_backrush.dart';
import 'package:dart_backrush/enums.dart';
import 'package:dart_backrush/models.dart';
