...
`,language:"server-nodejs",process:!0,children:(s,N)=>{n();var a=o(`const sdk = require('node-appwrite');
...
const message = await messaging.createSms(
        ...
        true,                                    // draft (optional)
        ''                                       // scheduledAt (optional)
    );`);e(s,a)},$$slots:{default:!0}});var T=t(g);O(T,{content:`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
`,language:"deno",process:!0,children:(s,N)=>{n();var a=o(`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
$result = $messaging->createSms(
    ...
    draft: true,                                  // optional
    scheduledAt: ''                               // optional
);`);e(s,a)},$$slots:{default:!0}});var f=t($);O(f,{content:`from appwrite.client import Client
...
`,language:"python",process:!0,children:(s,N)=>{n();var a=o(`from appwrite.client import Client
from appwrite.services.messaging import Messaging
...
result = messaging.create_sms(
    ...
    draft = True,                               # optional
    scheduled_at = ''                           # optional
)`);e(s,a)},$$slots:{default:!0}});var S=t(f);O(S,{content:`require 'appwrite'
...
`,language:"ruby",process:!0,children:(s,N)=>{n();var a=o(`require 'appwrite'
...
Message result = await messaging.CreateSMS(
    ...
    targets: new List<string> {}                  // optional    
    draft: true                                   // optional    
    scheduledAt: "");                             // optional`);e(s,a)},$$slots:{default:!0}});var M=t(w);O(M,{content:`import 'package:dart_appwrite/dart_appwrite.dart';
...
`,language:"dart",process:!0,children:(s,N)=>{n();var a=o(`import 'package:dart_appwrite/dart_appwrite.dart';
import 'package:dart_appwrite/enums.dart';
import 'package:dart_appwrite/models.dart';
...
}`);e(s,a)},$$slots:{default:!0}});var r=t(M);O(r,{content:`import io.appwrite.Client;
...
`,language:"kotlin",process:!0,children:(s,N)=>{n();var a=o(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
);`);e(s,a)},$$slots:{default:!0}});var m=t(r);O(m,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
`,language:"java",process:!0,children:(s,N)=>{n();var a=o(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
`,language:"server-nodejs",process:!0,children:(r,m)=>{n();var i=o(`const sdk = require('node-appwrite');
...
const provider = await messaging.updateTwilioProvider(
        ...
        '[AUTH_TOKEN]',                          // authToken (optional)
        '[FROM]'                                 // from (optional)
    );`);e(r,i)},$$slots:{default:!0}});var A=t(I);O(A,{content:`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
`,language:"deno",process:!0,children:(r,m)=>{n();var i=o(`import * as sdk from "https://deno.land/x/appwrite/mod.ts";
...
$result = $messaging->updateTwilioProvider(
    ...
    authToken: '[AUTH_TOKEN]',                    // optional
    from: '[FROM]'                                // optional
);`);e(r,i)},$$slots:{default:!0}});var g=t(_);O(g,{content:`from appwrite.client import Client
from appwrite.services.messaging import Messaging
...
`,language:"python",process:!0,children:(r,m)=>{n();var i=o(`from appwrite.client import Client
from appwrite.services.messaging import Messaging
...
result = messaging.update_twilio_provider(
    ...
    auth_token = '[AUTH_TOKEN]',                # optional
    from = '[FROM]'                             # optional
)`);e(r,i)},$$slots:{default:!0}});var T=t(g);O(T,{content:`require 'appwrite'
...
puts response.inspect
`,language:"ruby",process:!0,children:(r,m)=>{n();var i=o(`require 'appwrite'
...
Provider result = await messaging.UpdateTwilioProvider(
    ...
    accountSid: "[ACCOUNT_SID]"                   // optional
    authToken: "[AUTH_TOKEN]"                     // optional
    from: "[FROM]");                              // optional`);e(r,i)},$$slots:{default:!0}});var f=t($);O(f,{content:`import 'package:dart_appwrite/dart_appwrite.dart';
import 'package:dart_appwrite/enums.dart';
import 'package:dart_appwrite/models.dart';
...
`,language:"dart",process:!0,children:(r,m)=>{n();var i=o(`import 'package:dart_appwrite/dart_appwrite.dart';
import 'package:dart_appwrite/enums.dart';
import 'package:dart_appwrite/models.dart';
...
}`);e(r,i)},$$slots:{default:!0}});var S=t(f);O(S,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
`,language:"kotlin",process:!0,children:(r,m)=>{n();var i=o(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
);`);e(r,i)},$$slots:{default:!0}});var w=t(S);O(w,{content:`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
...
`,language:"java",process:!0,children:(r,m)=>{n();var i=o(`import io.appwrite.Client;
import io.appwrite.coroutines.CoroutineCallback;
import io.appwrite.services.Messaging;
