...
`,language:"server-nodejs",process:!0,children:(u,D)=>{e();var $=n(`const sdk = require('node-backrush');
...
promise.then(function (response) {
    ...
    console.log(error);
});`);t(u,$)},$$slots:{default:!0}});var P=r(i);C(P,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
`,language:"deno",process:!0,children:(u,D)=>{e();var $=n(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$result = $storage->createBucket('[BUCKET_ID]', '[NAME]');`);t(u,$)},$$slots:{default:!0}});var d=r(l);C(d,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(u,D)=>{e();var $=n(`from backrush.client import Client
from backrush.services.storage import Storage
...
Bucket result = await storage.CreateBucket(
    bucketId: "[BUCKET_ID]",
    name: "[NAME]");`);t(u,$)},$$slots:{default:!0}});var Z=r(A);C(Z,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(u,D)=>{e();var $=n(`import 'package:dart_backrush/dart_backrush.dart';
...
}`);t(u,$)},$$slots:{default:!0}});var ee=r(Z);C(ee,{content:`import io.backrush.Client
...
`,language:"kotlin",process:!0,children:(u,D)=>{e();var $=n(`import io.backrush.Client
import io.backrush.services.Storage
...
val response = storage.createBucket(
    bucketId = "[BUCKET_ID]",
    name = "[NAME]",
)`);t(u,$)},$$slots:{default:!0}});var te=r(ee);C(te,{content:`import io.backrush.Client;
...
`,language:"java",process:!0,children:(u,D)=>{e();var $=n(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Storage;
