...
`,language:"server-nodejs",process:!0,children:(s,r)=>{t();var d=o(`const sdk = require('node-backrush');
...
const result = await tokens.createFileToken(
    ...
    '<FILE_ID>', // fileId
    '' // expire (optional)
);`);e(s,d)},$$slots:{default:!0}});var I=n(p);l(I,{content:`from backrush.client import Client
from backrush.services.tokens import Tokens
...
`,language:"server-python",process:!0,children:(s,r)=>{t();var d=o(`from backrush.client import Client
from backrush.services.tokens import Tokens
...
result = tokens.create_file_token(
    ...
    file_id = '<FILE_ID>',
    expire = '' # optional
)`);e(s,d)},$$slots:{default:!0}});var c=n(I);l(c,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"server-dart",process:!0,children:(s,r)=>{t();var d=o(`import 'package:dart_backrush/dart_backrush.dart';
...
$result = $tokens->createFileToken(
    ...
    fileId: '<FILE_ID>',
    expire: '' // optional
);`);e(s,d)},$$slots:{default:!0}});var u=n(a);l(u,{content:`require 'backrush'
...
`,language:"server-ruby",process:!0,children:(s,r)=>{t();var d=o(`require 'backrush'
...
ResourceToken result = await tokens.CreateFileToken(
    ...
    fileId: "<FILE_ID>",
    expire: "" // optional
);`);e(s,d)},$$slots:{default:!0}});var R=n(k);l(R,{content:`import { Client, Tokens } from "https://deno.land/x/backrush/mod.ts";
...
`,language:"server-deno",process:!0,children:(s,r)=>{t();var d=o(`import { Client, Tokens } from "https://deno.land/x/backrush/mod.ts";
...
func main() {
    ...
    client.SetEndpoint("https://<REGION>.cloud.backrush.io/v1") // Your API Endpoint
...
let resourceToken = try await tokens.createFileToken(
    ...
    fileId: "<FILE_ID>",
    expire: "" // optional
)`);e(s,d)},$$slots:{default:!0}});var x=n(h);l(x,{content:`import io.backrush.Client
import io.backrush.coroutines.CoroutineCallback
import io.backrush.services.Tokens
...
`,language:"server-kotlin",process:!0,children:(s,r)=>{t();var d=o(`import io.backrush.Client
import io.backrush.coroutines.CoroutineCallback
import io.backrush.services.Tokens
...
val response = tokens.createFileToken(
    ...
    fileId = "<FILE_ID>",
    expire = "" // optional
)`);e(s,d)},$$slots:{default:!0}});var w=n(x);l(w,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Tokens;
...
`,language:"server-java",process:!0,children:(s,r)=>{t();var d=o(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Tokens;
...
const result = await tokens.list(
    ...
    '<FILE_ID>', // fileId
    [] // queries (optional)
);`);e(s,d)},$$slots:{default:!0}});var c=n(I);l(c,{content:`from backrush.client import Client
from backrush.services.tokens import Tokens
...
result = tokens.list(
    ...
    file_id = '<FILE_ID>',
    queries = [] # optional
)`);e(s,d)},$$slots:{default:!0}});var a=n(c);l(a,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
$result = $tokens->list(
    ...
    fileId: '<FILE_ID>',
    queries: [] // optional
);`);e(s,d)},$$slots:{default:!0}});var k=n(u);l(k,{content:`require 'backrush'
...
ResourceTokenList result = await tokens.List(
    ...
    fileId: "<FILE_ID>",
    queries: new List<string>() // optional
);`);e(s,d)},$$slots:{default:!0}});var K=n(R);l(K,{content:`import { Client, Tokens } from "https://deno.land/x/backrush/mod.ts";
...
val response = tokens.list(
    ...
    fileId = "<FILE_ID>",
    queries = listOf() // optional
)`);e(s,d)},$$slots:{default:!0}});var m=n(w);l(m,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Tokens;
...
`,language:"server-nodejs",process:!0,children:(i,s)=>{t();var r=o(`const sdk = require('node-backrush');
...
const result = await tokens.update(
    '<TOKEN_ID>', // tokenId
    '' // expire (optional)
);`);e(i,r)},$$slots:{default:!0}});var p=n(_);l(p,{content:`from backrush.client import Client
from backrush.services.tokens import Tokens
...
`,language:"server-python",process:!0,children:(i,s)=>{t();var r=o(`from backrush.client import Client
from backrush.services.tokens import Tokens
...
result = tokens.update(
    token_id = '<TOKEN_ID>',
    expire = '' # optional
)`);e(i,r)},$$slots:{default:!0}});var I=n(p);l(I,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"server-dart",process:!0,children:(i,s)=>{t();var r=o(`import 'package:dart_backrush/dart_backrush.dart';
...
$result = $tokens->update(
    tokenId: '<TOKEN_ID>',
    expire: '' // optional
);`);e(i,r)},$$slots:{default:!0}});var a=n(c);l(a,{content:`require 'backrush'
...
`,language:"server-ruby",process:!0,children:(i,s)=>{t();var r=o(`require 'backrush'
...
ResourceToken result = await tokens.Update(
    tokenId: "<TOKEN_ID>",
    expire: "" // optional
);`);e(i,r)},$$slots:{default:!0}});var k=n(u);l(k,{content:`import { Client, Tokens } from "https://deno.land/x/backrush/mod.ts";
...
`,language:"server-deno",process:!0,children:(i,s)=>{t();var r=o(`import { Client, Tokens } from "https://deno.land/x/backrush/mod.ts";
...
let resourceToken = try await tokens.update(
    tokenId: "<TOKEN_ID>",
    expire: "" // optional
)`);e(i,r)},$$slots:{default:!0}});var h=n(K);l(h,{content:`import io.backrush.Client
import io.backrush.coroutines.CoroutineCallback
import io.backrush.services.Tokens
...
`,language:"server-kotlin",process:!0,children:(i,s)=>{t();var r=o(`import io.backrush.Client
import io.backrush.coroutines.CoroutineCallback
import io.backrush.services.Tokens
...
val response = tokens.update(
    tokenId = "<TOKEN_ID>",
    expire = "" // optional
)`);e(i,r)},$$slots:{default:!0}});var x=n(h);l(x,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Tokens;
...
`,language:"server-java",process:!0,children:(i,s)=>{t();var r=o(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
import io.backrush.services.Tokens;
