...
`,language:"client-web",process:!0,children:(w,y)=>{o();var m=c(`import { Client, Storage } from "appwrite";
...
console.log(result.href);`);e(w,m)},$$slots:{default:!0}});var I=t(P);Y(I,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(w,y)=>{o();var m=c(`import 'package:appwrite/appwrite.dart';
...
}`);e(w,m)},$$slots:{default:!0}});var A=t(k);Y(A,{content:`import { Client, Storage, ImageGravity } from 'react-native-appwrite';
...
`,language:"client-react-native",process:!0,children:(w,y)=>{o();var m=c(`import { Client, Storage, ImageGravity } from 'react-native-appwrite';
import { Image } from 'react-native';
