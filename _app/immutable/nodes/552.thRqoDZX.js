...
`,language:"client-web",process:!0,children:(v,H)=>{n();var S=s(`import { Client, Storage } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(v,S)},$$slots:{default:!0}});var M=t(j);O(M,{content:`const sdk = require('node-appwrite');
...
`,language:"server-nodejs",process:!0,children:(v,H)=>{n();var S=s(`const sdk = require('node-appwrite');
const { InputFile } = require('node-appwrite/file');
...
// If running in Node.js, use InputFile
const nodeFile = InputFile.fromPath('/path/to/file.jpg', 'file.jpg');
await storage.createFile('<BUCKET_ID>', ID.unique(), nodeFile);`);e(v,S)},$$slots:{default:!0}});var N=t(M);O(N,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(v,H)=>{n();var S=s(`import 'package:appwrite/appwrite.dart';
...
}`);e(v,S)},$$slots:{default:!0}});var G=t(N);O(G,{content:`import io.appwrite.Client
...
`,language:"client-android-kotlin",process:!0,children:(v,H)=>{n();var S=s(`import io.appwrite.Client
import io.appwrite.services.Storage
...
}`);e(v,S)},$$slots:{default:!0}});var X=t(G);O(X,{content:`import { Client, Storage, ID } from 'react-native-appwrite';
...
`,language:"client-react-native",process:!0,children:(v,H)=>{n();var S=s(`import { Client, Storage, ID } from 'react-native-appwrite';
...
`,language:"client-web",process:!0,children:(D,K)=>{n();var v=s(`import { Client, Storage } from "appwrite";
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(D,v)},$$slots:{default:!0}});var M=t(j);O(M,{content:`import 'package:appwrite/appwrite.dart';
...
`,language:"client-flutter",process:!0,children:(D,K)=>{n();var v=s(`import 'package:appwrite/appwrite.dart';
...
}`);e(D,v)},$$slots:{default:!0}});var X=t(G);O(X,{content:`import { Client, Storage } from 'react-native-appwrite';
...
`,language:"client-react-native",process:!0,children:(D,K)=>{n();var v=s(`import { Client, Storage } from 'react-native-appwrite';
...
promise.then(function (response) {
    ...
    console.log(error); // Failure
});`);e(D,v)},$$slots:{default:!0}}),e(b,I)},$$slots:{default:!0}});var Ce=t(De);oe(Ce,{id:"download-file",level:1,children:(b,q)=>{n();var I=s("Download file");e(b,I)},$$slots:{default:!0}});var be=t(Ce);Y(be,{children:(b,q)=>{n();var I=pr(),j=t(o(I));h(j,{content:"getFileDownload"}),n(),e(b,I)},$$slots:{default:!0}});var Fe=t(be);le(Fe,{children:(b,q)=>{var I=ur(),j=o(I);O(j,{content:`import { Client, Storage } from "appwrite";
...
console.log(result); // Resource URL`);e(D,v)},$$slots:{default:!0}});var M=t(j);O(M,{content:`import 'package:appwrite/appwrite.dart';
...
}`);e(D,v)},$$slots:{default:!0}});var X=t(G);O(X,{content:`import { Client, Storage, ImageGravity } from 'react-native-appwrite';
...
console.log(result); // Resource URL
`,language:"client-react-native",process:!0,children:(D,K)=>{n();var v=s(`import { Client, Storage, ImageGravity } from 'react-native-appwrite';
...
console.log(result); // Resource URL`);e(D,v)},$$slots:{default:!0}}),e(b,I)},$$slots:{default:!0}});var Re=t(xe);oe(Re,{id:"view-file",level:1,children:(b,q)=>{n();var I=s("View File");e(b,I)},$$slots:{default:!0}});var Be=t(Re);Y(Be,{children:(b,q)=>{n();var I=fr(),j=t(o(I));h(j,{content:"getFileView"}),n(),e(b,I)},$$slots:{default:!0}});var Ue=t(Be);le(Ue,{children:(b,q)=>{var I=vr(),j=o(I);O(j,{content:`import { Client, Storage } from "appwrite";
