...
cd my-app`);o(s,n)},$$slots:{default:!0}}),o(h,i)},$$slots:{default:!0}});var F=t(q);I(F,{id:"step-3",step:3,title:"Install Backrush",children:(h,x)=>{var i=et(),m=_(i);l(m,{children:(d,g)=>{r();var v=p("Install the JavaScript Backrush SDK.");o(d,v)},$$slots:{default:!0}});var $=t(m);y($,{content:`npm install appwrite@14.0.1
`,language:"sh",process:!0,children:(d,g)=>{r();var v=p("npm install appwrite@14.0.1");o(d,v)},$$slots:{default:!0}}),o(h,i)},$$slots:{default:!0}});var N=t(F);I(N,{id:"step-4",step:4,title:"Import Backrush",children:(h,x)=>{var i=nt(),m=_(i);l(m,{children:(s,a)=>{r();var n=rt(),e=t(_(n));j(e,{marker:"**",children:(u,c)=>{r();var w=p("Settings");o(u,w)},$$slots:{default:!0}}),r(),o(s,n)},$$slots:{default:!0}});var $=t(m);U($,{children:(s,a)=>{l(s,{children:(n,e)=>{A(n,{src:"/images/docs/quick-starts/dark/project-id.png",alt:"Project settings screen"})},$$slots:{default:!0}})}});var d=t($);S(d,{children:(s,a)=>{l(s,{children:(n,e)=>{A(n,{src:"/images/docs/quick-starts/project-id.png",alt:"Project settings screen"})},$$slots:{default:!0}})}});var g=t(d);l(g,{children:(s,a)=>{r();var n=ot(),e=t(_(n));P(e,{content:"src/lib/appwrite.ts"});var u=t(e,2);P(u,{content:"<PROJECT_ID>"}),r(),o(s,n)},$$slots:{default:!0}});var v=t(g);y(v,{content:`import { Client, Account} from 'appwrite';
...
`,language:"client-web",process:!0,children:(s,a)=>{r();var n=p(`import { Client, Account} from 'appwrite';
...
export const account = new Account(client);
export { ID } from 'appwrite';`);o(s,n)},$$slots:{default:!0}}),o(h,i)},$$slots:{default:!0}});var O=t(N);I(O,{id:"step-5",step:5,title:"Create a login page",children:(h,x)=>{var i=pt(),m=_(i);l(m,{children:(a,n)=>{r();var e=at(),u=t(_(e));P(u,{content:"FormsModule"}),r(),o(a,e)},$$slots:{default:!0}});var $=t(m);y($,{content:`import { FormsModule } from '@angular/forms';
...
@NgModule({
  declarations: [
    // ...
