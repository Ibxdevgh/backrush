...
`,language:"client-web",process:!0,children:(d,w)=>{r();var v=c(`import { Client, Account} from 'appwrite';
...
export const account = new Account(client);
export { ID } from 'appwrite';`);e(d,v)},$$slots:{default:!0}}),e($,s)},$$slots:{default:!0}});var J=t(T);y(J,{id:"step-5",step:5,title:"Create a login page",children:($,P)=>{var s=st(),p=_(s);i(p,{children:(n,m)=>{r();var a=at(),d=t(_(a));k(d,{content:"app.vue"}),r(),e(n,a)},$$slots:{default:!0}});var u=t(p);A(u,{content:`<script setup>
import { ref } from 'vue';
