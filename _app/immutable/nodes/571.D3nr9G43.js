...
export const account = new Account(client);
export { ID } from 'appwrite';`);e(d,g)},$$slots:{default:!0}}),e($,s)},$$slots:{default:!0}});var J=t(T);y(J,{id:"step-5",step:5,title:"Create a login page",children:($,P)=>{var s=st(),i=h(s);p(i,{children:(n,m)=>{r();var a=at(),d=t(h(a));C(d,{content:"src/App.jsx"}),r(),e(n,a)},$$slots:{default:!0}});var u=t(i);j(u,{content:`import React, { useState } from 'react';
