...
export const account = new Account(client);
export { ID } from 'appwrite';`);e(d,g)},$$slots:{default:!0}}),e($,s)},$$slots:{default:!0}});var T=t(F);y(T,{id:"step-5",step:5,title:"Create a login page",children:($,P)=>{var s=st(),p=_(s);i(p,{children:(n,m)=>{r();var a=at(),d=t(_(a));x(d,{content:"src/routes/+page.svelte"}),r(),e(n,a)},$$slots:{default:!0}});var u=t(p);k(u,{content:`<script>
