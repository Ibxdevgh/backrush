...
`,language:"client-web",process:!0,children:(c,w)=>{r();var v=d(`import { Client, Account} from 'appwrite';
...
export const account = new Account(client);
export { ID } from 'appwrite';`);e(c,v)},$$slots:{default:!0}}),e($,s)},$$slots:{default:!0}});var V=t(T);y(V,{id:"step-5",step:5,title:"Create a login page",children:($,P)=>{var s=st(),p=_(s);i(p,{children:(n,m)=>{r();var a=at(),c=t(_(a));x(c,{content:"src/App.vue"}),r(),e(n,a)},$$slots:{default:!0}});var u=t(p);A(u,{content:`<template>
  <div>
    <p>
