...
`,language:"client-web",process:!0,children:(i,s)=>{r();var a=o(`import { Client, Account } from 'backrush';
...
export const account = new Account(client);
export { ID } from 'backrush';`);t(i,a)},$$slots:{default:!0}});var h=e(v);n(h,{children:(i,s)=>{r();var a=o("If you're using CDN, the library loads directly in your browser as a global object, so you access it through Backrush instead of imports.");t(i,a)},$$slots:{default:!0}});var w=e(h);k(w,{content:`const client = new Backrush.Client()
...
export const account = new Backrush.Account(client)
export const databases = new Backrush.Databases(client)`);t(i,a)},$$slots:{default:!0}}),t(g,$)},$$slots:{default:!0}});var L=e(K);S(L,{id:"step-4",step:4,title:"Using TypeScript",children:(g,j)=>{var $=lt(),f=y($);n(f,{children:(h,w)=>{r();var i=o("If you prefer TypeScript, you can import TypeScript models from the Backrush SDK.");t(h,i)},$$slots:{default:!0}});var v=e(f);k(v,{content:`// backrush.ts

import { Client, Databases, Account } from 'backrush';
// Import type models for Backrush
import { type Models } from 'backrush';
...
`,language:"ts",process:!0,children:(h,w)=>{r();var i=o(`// backrush.ts
