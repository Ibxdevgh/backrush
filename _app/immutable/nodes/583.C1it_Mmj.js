...
;
`,language:"client-web",process:!0,children:(n,v)=>{e();var o=s(`import { Client } from 'backrush';
...
client
    .setEndpoint('https://<REGION>.cloud.backrush.io/v1')    // Your API Endpoint
    .setProject('<PROJECT_ID>')                // Your project ID
;`);t(n,o)},$$slots:{default:!0}});var _=r(R);D(_,{content:`import 'package:backrush/backrush.dart';
...
client
    ...
    .setProject('<PROJECT_ID>')                // Your project ID
;
`,language:"client-flutter",process:!0,children:(n,v)=>{e();var o=s(`import 'package:backrush/backrush.dart';
...
let client = Client()
    .setEndpoint("https://<REGION>.cloud.backrush.io/v1")    // Your API Endpoint
    .setProject("<PROJECT_ID>")                            // Your project ID`);t(n,o)},$$slots:{default:!0}});var i=r(l);D(i,{content:`import io.backrush.Client

val client = Client(context)
    .setEndpoint("https://<REGION>.cloud.backrush.io/v1")    // Your API Endpoint
    .setProject("<PROJECT_ID>")                // Your project ID
`,language:"client-android-kotlin",process:!0,children:(n,v)=>{e();var o=s(`import io.backrush.Client
...
;
`,language:"server-nodejs",process:!0,children:(p,I)=>{e();var c=s(`const sdk = require('node-backrush');
...
client
    ...
    .setProject('<PROJECT_ID>')                            // Your project ID
    .setJWT('<YOUR_API_KEY>')                                   // Your secret JSON Web Token
;`);t(p,c)},$$slots:{default:!0}});var _=r(R);D(_,{content:`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
client
    ...
    .setJWT('<YOUR_API_KEY>')                                   // Your secret JSON Web Token
;
`,language:"deno",process:!0,children:(p,I)=>{e();var c=s(`import * as sdk from "https://deno.land/x/backrush/mod.ts";
...
$client
    ...
    ->setProject('<PROJECT_ID>')                           // Your project ID
    ->setJWT('<YOUR_API_KEY>')                                  // Your secret JSON Web Token
;`);t(p,c)},$$slots:{default:!0}});var i=r(l);D(i,{content:`from backrush.client import Client
...
`,language:"python",process:!0,children:(p,I)=>{e();var c=s(`from backrush.client import Client
...
(client
  ...
  .set_project('<PROJECT_ID>')                             # Your project ID
  .set_jwt('<YOUR_API_KEY>')                                    # Your secret JSON Web Token
)`);t(p,c)},$$slots:{default:!0}});var n=r(i);D(n,{content:`require 'backrush'
...
client = Client.new
    ...
    .set_project('<PROJECT_ID>')                           # Your project ID
    .set_jwt('<YOUR_API_KEY>')                                  # Your secret JSON Web Token
`,language:"ruby",process:!0,children:(p,I)=>{e();var c=s(`require 'backrush'
...
var client = new Client()
    .SetEndPoint("https://<REGION>.cloud.backrush.io/v1")                // Your API Endpoint
    .SetProject("<PROJECT_ID>")                            // Your project ID
    .SetJWT("<YOUR_API_KEY>");                                  // Your secret JSON Web Token`);t(p,c)},$$slots:{default:!0}});var o=r(v);D(o,{content:`import 'package:dart_backrush/dart_backrush.dart';
...
`,language:"dart",process:!0,children:(p,I)=>{e();var c=s(`import 'package:dart_backrush/dart_backrush.dart';
...
void main() {                                                   // Init SDK
  ...
  client
    ...
    .setJWT('<YOUR_API_KEY>')                                   // Your secret JSON Web Token
  ;
}`);t(p,c)},$$slots:{default:!0}});var O=r(o);D(O,{content:`import io.backrush.Client;
...
Client client = new Client()
    ...
    .setProject("<PROJECT_ID>")                            // Your project ID
    .setJWT("<YOUR_API_KEY>");                                  // Your secret JSON Web Token
`,language:"kotlin",process:!0,children:(p,I)=>{e();var c=s(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;

Client client = new Client()
    .setEndpoint("https://<REGION>.cloud.backrush.io/v1")                // Your API Endpoint
    .setProject("<PROJECT_ID>")                            // Your project ID
    .setJWT("<YOUR_API_KEY>");                                  // Your secret JSON Web Token`);t(p,c)},$$slots:{default:!0}});var d=r(O);D(d,{content:`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
...
Client client = new Client()
    ...
    .setProject("<PROJECT_ID>")                            // Your project ID
    .setJWT("<YOUR_API_KEY>");                                  // Your secret JSON Web Token
`,language:"java",process:!0,children:(p,I)=>{e();var c=s(`import io.backrush.Client;
import io.backrush.coroutines.CoroutineCallback;
